...
public class ExampleCodeGenerationModule extends AbstractCodeGenerationModule {
    /**
     * Return the {@link de.fhdo.lemma.model_processing.languages.LanguageDescription} instance of the modeling
     * language, from whose models code shall be generated
     */
    @NotNull
    @Override
    ...
    public Map<String, Pair<String, Charset>> execute(@NotNull String[] phaseArguments,
         ...
         * {@link getLanguageDescription} tells the framework that this module shall work on intermediate service
         * models). To retrieve the {@link org.eclipse.emf.ecore.resource.Resource} of the model, we can rely on
         * the {@link de.fhdo.lemma.model_processing.builtin_phases.code_generation.AbstractCodeGenerationModule#getIntermediateModelResource}
         * method.
         */
