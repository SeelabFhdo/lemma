...
import de.fhdo.lemma.service.open_api.exceptions.ComplexTypeException
import de.fhdo.lemma.service.open_api.exceptions.MatchingException
...
class LemmaServiceSubGenerator {
    ...
    def de.fhdo.lemma.service.Parameter createLemmaInParameterFromMediaTypeValue(Schema schema) {
        ...
        newLemmaParam.name = StringUtils.uncapitalize("bodyRequest")
