 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.service.Endpoint#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.Endpoint#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.Endpoint#getMicroservice <em>Microservice</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.Endpoint#getInterface <em>Interface</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.Endpoint#getOperation <em>Operation</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.Endpoint#getReferredOperation <em>Referred Operation</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.service.ServicePackage#getEndpoint()
 * @model
 * @generated
 */
public interface Endpoint extends EObject {
     ...
     * @see de.fhdo.ddmm.service.ServicePackage#getEndpoint_Addresses()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.service.Microservice#getEndpoints <em>Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.service.ServicePackage#getEndpoint_Microservice()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.service.Endpoint#getMicroservice <em>Microservice</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.service.Interface#getEndpoints <em>Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.service.ServicePackage#getEndpoint_Interface()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.service.Endpoint#getInterface <em>Interface</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.service.Operation#getEndpoints <em>Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.service.ServicePackage#getEndpoint_Operation()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.service.Endpoint#getOperation <em>Operation</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.service.ReferredOperation#getEndpoints <em>Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.service.ServicePackage#getEndpoint_ReferredOperation()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.service.Endpoint#getReferredOperation <em>Referred Operation</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
