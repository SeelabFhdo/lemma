...
entryRuleTechnologyMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTechnologyMappingRule()); }
	iv_ruleTechnologyMapping=ruleTechnologyMapping
	{ $current=$iv_ruleTechnologyMapping.current; }
	EOF;

// Rule TechnologyMapping
ruleTechnologyMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleImportedComplexTypeToMap returns [EObject current=null]:
	...
	{ $current=$iv_ruleImportedComplexTypeToMap.current; }
	EOF;

// Rule ImportedComplexTypeToMap
ruleImportedComplexTypeToMap returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleMicroserviceMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMicroserviceMappingRule()); }
	iv_ruleMicroserviceMapping=ruleMicroserviceMapping
	{ $current=$iv_ruleMicroserviceMapping.current; }
	EOF;

// Rule MicroserviceMapping
ruleMicroserviceMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleInterfaceMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInterfaceMappingRule()); }
	iv_ruleInterfaceMapping=ruleInterfaceMapping
	{ $current=$iv_ruleInterfaceMapping.current; }
	EOF;

// Rule InterfaceMapping
ruleInterfaceMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleReferredOperationMapping returns [EObject current=null]:
	...
	{ $current=$iv_ruleReferredOperationMapping.current; }
	EOF;

// Rule ReferredOperationMapping
ruleReferredOperationMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulePrimitiveParameterMapping returns [EObject current=null]:
	...
	{ $current=$iv_rulePrimitiveParameterMapping.current; }
	EOF;

// Rule PrimitiveParameterMapping
rulePrimitiveParameterMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleComplexParameterMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getComplexParameterMappingRule()); }
	iv_ruleComplexParameterMapping=ruleComplexParameterMapping
	{ $current=$iv_ruleComplexParameterMapping.current; }
	EOF;

// Rule ComplexParameterMapping
ruleComplexParameterMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTechnologySpecificFieldMapping returns [EObject current=null]:
	...
	{ $current=$iv_ruleTechnologySpecificFieldMapping.current; }
	EOF;

// Rule TechnologySpecificFieldMapping
ruleTechnologySpecificFieldMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDataOperationMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDataOperationMappingRule()); }
	iv_ruleDataOperationMapping=ruleDataOperationMapping
	{ $current=$iv_ruleDataOperationMapping.current; }
	EOF;

// Rule DataOperationMapping
ruleDataOperationMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDataOperationReturnTypeMapping returns [EObject current=null]:
	...
	{ $current=$iv_ruleDataOperationReturnTypeMapping.current; }
	EOF;

// Rule DataOperationReturnTypeMapping
ruleDataOperationReturnTypeMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDataOperationParameterMapping returns [EObject current=null]:
	...
	{ $current=$iv_ruleDataOperationParameterMapping.current; }
	EOF;

// Rule DataOperationParameterMapping
ruleDataOperationParameterMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleImportedMicroservice returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getImportedMicroserviceRule()); }
	iv_ruleImportedMicroservice=ruleImportedMicroservice
	{ $current=$iv_ruleImportedMicroservice.current; }
	EOF;

// Rule ImportedMicroservice
ruleImportedMicroservice returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTechnologySpecificProtocolSpecification returns [EObject current=null]:
	...
	{ $current=$iv_ruleTechnologySpecificProtocolSpecification.current; }
	EOF;

// Rule TechnologySpecificProtocolSpecification
ruleTechnologySpecificProtocolSpecification returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTechnologySpecificProtocol returns [EObject current=null]:
	...
	{ $current=$iv_ruleTechnologySpecificProtocol.current; }
	EOF;

// Rule TechnologySpecificProtocol
ruleTechnologySpecificProtocol returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			otherlv_3='('
			{
				newLeafNode(otherlv_3, grammarAccess.getTechnologySpecificProtocolAccess().getLeftParenthesisKeyword_3_0());
			}
			(
				(
					{
			...
			otherlv_5=')'
			{
				newLeafNode(otherlv_5, grammarAccess.getTechnologySpecificProtocolAccess().getRightParenthesisKeyword_3_2());
			}
		)?
	)
;
...
entryRuleTechnologySpecificEndpoint returns [EObject current=null]:
	...
	{ $current=$iv_ruleTechnologySpecificEndpoint.current; }
	EOF;

// Rule TechnologySpecificEndpoint
ruleTechnologySpecificEndpoint returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTechnologySpecificImportedServiceAspect returns [EObject current=null]:
	...
	{ $current=$iv_ruleTechnologySpecificImportedServiceAspect.current; }
	EOF;

// Rule TechnologySpecificImportedServiceAspect
ruleTechnologySpecificImportedServiceAspect returns [EObject current=null]
@init {
	enterRule();
}
@after {
