...
public class InternalServiceDslLexer extends Lexer {
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7288:13: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalServiceDsl.g:7288:15: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalServiceDsl.g:7288:19: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
            loop1:
            do {
                int alt1=3;
    ...
    public final void mRULE_BIG_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7290:18: ( ( '-' )? RULE_INT ( '.' RULE_INT )? )
            // InternalServiceDsl.g:7290:20: ( '-' )? RULE_INT ( '.' RULE_INT )?
            {
            // InternalServiceDsl.g:7290:20: ( '-' )?
            int alt2=2;
            ...
            mRULE_INT(); 
            // InternalServiceDsl.g:7290:34: ( '.' RULE_INT )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalServiceDsl.g:7290:35: '.' RULE_INT
                    {
                    match('.'); 
                    mRULE_INT(); 
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7292:14: ( ( 'true' | 'false' ) )
            // InternalServiceDsl.g:7292:16: ( 'true' | 'false' )
            {
            // InternalServiceDsl.g:7292:16: ( 'true' | 'false' )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalServiceDsl.g:7292:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalServiceDsl.g:7292:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7294:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalServiceDsl.g:7294:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalServiceDsl.g:7294:11: ( '^' )?
            int alt5=2;
            ...
            // InternalServiceDsl.g:7294:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalServiceDsl.g:7296:19: ( ( '0' .. '9' )+ )
            // InternalServiceDsl.g:7296:21: ( '0' .. '9' )+
            {
            // InternalServiceDsl.g:7296:21: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalServiceDsl.g:7296:22: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7298:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalServiceDsl.g:7298:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalServiceDsl.g:7298:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7300:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalServiceDsl.g:7300:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalServiceDsl.g:7300:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
            ...
            // InternalServiceDsl.g:7300:40: ( ( '\\r' )? '\\n' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalServiceDsl.g:7300:41: ( '\\r' )? '\\n'
                    {
                    // InternalServiceDsl.g:7300:41: ( '\\r' )?
                    int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7302:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalServiceDsl.g:7302:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalServiceDsl.g:7302:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalServiceDsl.g:7304:16: ( . )
            // InternalServiceDsl.g:7304:18: .
            {
            matchAny(); 
