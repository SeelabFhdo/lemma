...
public class ServiceDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class MicroserviceElements extends AbstractParserRuleElementFinder {
		...
		//technologyReferences+=TechnologyReference* (protocols+=ProtocolSpecification protocols+=ProtocolSpecification?)? ('@'
		//'endpoints' '(' endpoints+=Endpoint+ ')')? ('@' 'endpoints' '({' endpoints+=Endpoint+ '})')?
		//aspects+=ImportedServiceAspect* visibility=Visibility? type=MicroserviceType 'microservice'
		//name=QualifiedNameWithAtLeastOneLevel ('version' version=ID)? // TODO: Inheritance of microservices
		////('extends' super=[Microservice|QualifiedNameWithAtLeastOneLevel])?
	...
	public class InterfaceElements extends AbstractParserRuleElementFinder {
		...
		//(protocols+=ProtocolSpecification protocols+=ProtocolSpecification?)? ('@' 'endpoints' '(' endpoints+=Endpoint+ ')')?
		//('@' 'endpoints' '({' endpoints+=Endpoint+ '})')? aspects+=ImportedServiceAspect* notImplemented?='noimpl'?
		//visibility=Visibility? 'interface' name=ID ('version' version=ID)? '{' referredOperations+=ReferredOperation*
		//operations+=Operation* '}'
		public Group getGroup() { return cGroup; }
	...
	public class ReferredOperationElements extends AbstractParserRuleElementFinder {
		...
		//(protocols+=ProtocolSpecification protocols+=ProtocolSpecification?)? ('@' 'endpoints' '(' endpoints+=Endpoint+ ')')?
		//('@' 'endpoints' '({' endpoints+=Endpoint+ '})')? aspects+=ImportedServiceAspect* 'refers'
		//operation=[Operation|QualifiedName] ';'
		public Group getGroup() { return cGroup; }
	...
	public class AnythingElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cListKeyword_45 = (Keyword)cAlternatives.eContents().get(45);
		...
		private final Keyword cSelectorKeyword_66 = (Keyword)cAlternatives.eContents().get(66);
		private final Keyword cDatatypesKeyword_67 = (Keyword)cAlternatives.eContents().get(67);
		...
		private final Keyword cToKeyword_116 = (Keyword)cAlternatives.eContents().get(116);
		private final RuleCall cBOOLEANTerminalRuleCall_117 = (RuleCall)cAlternatives.eContents().get(117);
		private final RuleCall cNUMBER_WITH_TRAILING_PERIODTerminalRuleCall_118 = (RuleCall)cAlternatives.eContents().get(118);
		private final RuleCall cBIG_DECIMALTerminalRuleCall_119 = (RuleCall)cAlternatives.eContents().get(119);
		private final RuleCall cIDTerminalRuleCall_120 = (RuleCall)cAlternatives.eContents().get(120);
		private final RuleCall cSTRINGTerminalRuleCall_121 = (RuleCall)cAlternatives.eContents().get(121);
		private final RuleCall cANY_OTHERTerminalRuleCall_122 = (RuleCall)cAlternatives.eContents().get(122);
		...
		//	'utility' | 'to' | BOOLEAN | NUMBER_WITH_TRAILING_PERIOD | BIG_DECIMAL | ID | STRING | ANY_OTHER)+;
		@Override public ParserRule getRule() { return rule; }
		...
		//// specify them here, they will be recognized as regular grammar tokens in the Anything
		//// string.
		//'technology' | 'types' | 'compatibility' | 'matrix' | 'protocols' | 'service' | 'aspects' | 'deployment' |
		//'technologies' | 'infrastructure' | 'operation' | 'import' | 'from' | 'as' | 'data' | 'formats' | 'default' | 'with' |
		//'format' | 'in' | 'out' | 'inout' | 'sync' | 'async' | 'primitive' | 'type' | 'based' | 'on' | 'list' | 'structure' |
		//'->' | '<-' | '<->' | 'environments' | 'properties' | 'mandatory' | 'singleval' | 'microservices' | 'interfaces' |
		//'operations' | 'parameters' | 'fields' | 'exchange_pattern' | 'communication_type' | 'protocol' | 'data_format' |
		//'aspect' | 'for' | 'containers' | 'selector' | // All keywords of the Data DSL (from which the Service DSL inherits). If we don't specify
		//// them here, they will be recognized as regular grammar tokens in the Anything string.
		//'datatypes' | 'version' | 'context' | 'aggregate' | 'applicationService' | 'domainEvent' | 'domainService' | 'entity' |
		//'factory' | 'infrastructureService' | 'repository' | 'specification' | 'valueObject' | 'extends' | 'identifier' |
		//'neverEmpty' | 'part' | 'hide' | 'immutable' | 'enum' | 'closure' | 'sideEffectFree' | 'validator' | 'function' |
		...
		//| 'param' | 'refers' | 'fault' | 'functional' | 'utility' | 'to' | BOOLEAN | NUMBER_WITH_TRAILING_PERIOD | BIG_DECIMAL
		//| ID | STRING | ANY_OTHER)+
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//'list'
		public Keyword getListKeyword_45() { return cListKeyword_45; }
		...
		//'selector'
		public Keyword getSelectorKeyword_66() { return cSelectorKeyword_66; }
		
		//// All keywords of the Data DSL (from which the Service DSL inherits). If we don't specify
		//// them here, they will be recognized as regular grammar tokens in the Anything string.
		//'datatypes'
		public Keyword getDatatypesKeyword_67() { return cDatatypesKeyword_67; }
		...
		//'to'
		public Keyword getToKeyword_116() { return cToKeyword_116; }
		...
		//BOOLEAN
		public RuleCall getBOOLEANTerminalRuleCall_117() { return cBOOLEANTerminalRuleCall_117; }
		
		//NUMBER_WITH_TRAILING_PERIOD
		public RuleCall getNUMBER_WITH_TRAILING_PERIODTerminalRuleCall_118() { return cNUMBER_WITH_TRAILING_PERIODTerminalRuleCall_118; }
		
		//BIG_DECIMAL
		public RuleCall getBIG_DECIMALTerminalRuleCall_119() { return cBIG_DECIMALTerminalRuleCall_119; }
		
		//ID
		public RuleCall getIDTerminalRuleCall_120() { return cIDTerminalRuleCall_120; }
		
		//STRING
		public RuleCall getSTRINGTerminalRuleCall_121() { return cSTRINGTerminalRuleCall_121; }
		
		//ANY_OTHER
		public RuleCall getANY_OTHERTerminalRuleCall_122() { return cANY_OTHERTerminalRuleCall_122; }
	}
