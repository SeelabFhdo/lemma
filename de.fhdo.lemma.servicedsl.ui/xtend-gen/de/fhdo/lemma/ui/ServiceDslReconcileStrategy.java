...
public class ServiceDslReconcileStrategy extends XtextDocumentReconcileStrategy {
  /**
  ...
  private void reloadImportedModels(final XtextResource resource) {
    if ((resource.getContents().isEmpty() || (!(resource.getContents().get(0) instanceof ServiceModel)))) {
      return;
    }
