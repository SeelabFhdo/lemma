 ...
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#isEffectivelyImplemented <em>Effectively Implemented</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getTechnologies <em>Technologies</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getRequiredMicroservices <em>Required Microservices</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getRequiredInterfaces <em>Required Interfaces</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getRequiredOperations <em>Required Operations</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getInterfaces <em>Interfaces</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link de.fhdo.ddmm.service.intermediate.impl.IntermediateMicroserviceImpl#getServiceModel <em>Service Model</em>}</li>
 * </ul>
 *
 * @generated
 */
