 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.lemma.data.impl.ContextImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.fhdo.lemma.data.impl.ContextImpl#getComplexTypes <em>Complex Types</em>}</li>
 *   <li>{@link de.fhdo.lemma.data.impl.ContextImpl#getDataModel <em>Data Model</em>}</li>
 *   <li>{@link de.fhdo.lemma.data.impl.ContextImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case DataPackage.CONTEXT___BUILD_QUALIFIED_NAME__STRING:
