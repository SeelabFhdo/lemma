...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Structure Feature</b></em>',
 ...
 * <!-- end-model-doc -->
 * @see de.fhdo.lemma.data.DataPackage#getDataStructureFeature()
 * @model
 * @generated
 */
public enum DataStructureFeature implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>Structure Feature</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final DataStructureFeature[] VALUES_ARRAY =
        new DataStructureFeature[] {
            AGGREGATE,
            APPLICATION_SERVICE,
            DOMAIN_EVENT,
            DOMAIN_SERVICE,
    ...
    /**
     * A public read-only list of all the '<em><b>Structure Feature</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<DataStructureFeature> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Structure Feature</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static DataStructureFeature get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            DataStructureFeature result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Structure Feature</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static DataStructureFeature getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            DataStructureFeature result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Structure Feature</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static DataStructureFeature get(int value) {
        switch (value) {
     ...
     * @generated
     */
    private DataStructureFeature(int value, String name, String literal) {
        this.value = value;
        this.name = name;
