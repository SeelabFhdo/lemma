...
public class ServerConnectionDialog extends TitleAreaDialog {
  ...
  public Control createDialogArea(final Composite parent) {
    ...
    this.hostnameField = this.createTextField(container, "Hostname:", LiveValidationServer.DEFAULT_HOSTNAME);
  ...
  private int connectToServer(final String hostname, final int port) {
    int _xblockexpression = (int) 0;
    {
      ...
      final Function<ConnectProgressDialog, Void> _function = (ConnectProgressDialog it) -> {
        return this.connectionToServerEstablished(it);
      };
      final Function2<ConnectProgressDialog, Exception, Void> _function_1 = (ConnectProgressDialog dialog, Exception error) -> {
        return this.errorDuringConnectionAttemptCallback(dialog, error);
      };
