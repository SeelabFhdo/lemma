...
import de.fhdo.lemma.live_validation.client.AbstractLiveValidationInitiator;
...
public class ServerConnection {
  ...
  private static class LiveValidationClient extends AbstractLiveValidationInitiator {
    ...
    public void publishIssues(final PublishIssuesParams issues) {
      final Consumer<LiveValidationCapableXtextEditor> _function = (LiveValidationCapableXtextEditor it) -> {
