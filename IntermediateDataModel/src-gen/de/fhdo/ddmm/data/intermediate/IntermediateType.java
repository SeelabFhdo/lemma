 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getName <em>Name</em>}</li>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getOrigin <em>Origin</em>}</li>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getKind <em>Kind</em>}</li>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getDataField <em>Data Field</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateType()
 * @model abstract="true"
 * @generated
 */
public interface IntermediateType extends EObject {
     ...
     * @see #setName(String)
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateType_Name()
     * @model unique="false"
     * @generated
     */
    String getName();
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The literals are from the enumeration {@link de.fhdo.ddmm.data.intermediate.IntermediateTypeOrigin}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateType_Origin()
     * @model unique="false"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getOrigin <em>Origin</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateType_Kind()
     * @model unique="false"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getKind <em>Kind</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.data.intermediate.IntermediateDataField#getType <em>Type</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateType_DataField()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateType#getDataField <em>Data Field</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
