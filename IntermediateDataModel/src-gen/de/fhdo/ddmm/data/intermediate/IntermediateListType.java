 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#isPrimitiveList <em>Primitive List</em>}</li>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#isStructuredList <em>Structured List</em>}</li>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#getDataFields <em>Data Fields</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateListType()
 * @model
 * @generated
 */
public interface IntermediateListType extends IntermediateComplexType {
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateListType_PrimitiveList()
     * @model unique="false"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#isPrimitiveList <em>Primitive List</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateListType_StructuredList()
     * @model unique="false"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#isStructuredList <em>Structured List</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateListType_PrimitiveType()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.data.intermediate.IntermediateListType#getPrimitiveType <em>Primitive Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.data.intermediate.IntermediateDataField#getListType <em>List Type</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.data.intermediate.IntermediatePackage#getIntermediateListType_DataFields()
