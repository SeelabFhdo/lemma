 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.operation.BasicEndpoint#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.BasicEndpoint#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.BasicEndpoint#getContainer <em>Container</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.BasicEndpoint#getInfrastructureNode <em>Infrastructure Node</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.BasicEndpoint#getDeploymentSpecification <em>Deployment Specification</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.operation.OperationPackage#getBasicEndpoint()
 * @model
 * @generated
 */
public interface BasicEndpoint extends EObject {
     ...
     * @see de.fhdo.ddmm.operation.OperationPackage#getBasicEndpoint_Addresses()
     ...
     * The list contents are of type {@link de.fhdo.ddmm.operation.ProtocolAndDataFormat}.
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.operation.ProtocolAndDataFormat#getEndpoint <em>Endpoint</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.operation.OperationPackage#getBasicEndpoint_Protocols()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.operation.Container#getDefaultBasicEndpoints <em>Default Basic Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.operation.OperationPackage#getBasicEndpoint_Container()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.operation.BasicEndpoint#getContainer <em>Container</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.operation.InfrastructureNode#getEndpoints <em>Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.operation.OperationPackage#getBasicEndpoint_InfrastructureNode()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.operation.BasicEndpoint#getInfrastructureNode <em>Infrastructure Node</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.operation.ServiceDeploymentSpecification#getBasicEndpoints <em>Basic Endpoints</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.operation.OperationPackage#getBasicEndpoint_DeploymentSpecification()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.operation.BasicEndpoint#getDeploymentSpecification <em>Deployment Specification</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
