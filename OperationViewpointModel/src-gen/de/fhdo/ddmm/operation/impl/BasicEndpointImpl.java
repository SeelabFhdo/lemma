 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.operation.impl.BasicEndpointImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.impl.BasicEndpointImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.impl.BasicEndpointImpl#getContainer <em>Container</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.impl.BasicEndpointImpl#getInfrastructureNode <em>Infrastructure Node</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.impl.BasicEndpointImpl#getDeploymentSpecification <em>Deployment Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicEndpointImpl extends MinimalEObjectImpl.Container implements BasicEndpoint {
     ...
     * @generated
     */
    public de.fhdo.ddmm.operation.Container basicGetContainer() {
        if (eContainerFeatureID() != OperationPackage.BASIC_ENDPOINT__CONTAINER) return null;
        return (de.fhdo.ddmm.operation.Container)eInternalContainer();
    }
     ...
     * @generated
     */
    public NotificationChain basicSetContainer(de.fhdo.ddmm.operation.Container newContainer, NotificationChain msgs) {
    ...
    public void setContainer(de.fhdo.ddmm.operation.Container newContainer) {
        if (newContainer != eInternalContainer() || (eContainerFeatureID() != OperationPackage.BASIC_ENDPOINT__CONTAINER && newContainer != null)) {
            ...
            if (newContainer != null)
                msgs = ((InternalEObject)newContainer).eInverseAdd(this, OperationPackage.CONTAINER__DEFAULT_BASIC_ENDPOINTS, de.fhdo.ddmm.operation.Container.class, msgs);
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case OperationPackage.BASIC_ENDPOINT__CONTAINER:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
                return basicSetContainer((de.fhdo.ddmm.operation.Container)otherEnd, msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case OperationPackage.BASIC_ENDPOINT__CONTAINER:
                return eInternalContainer().eInverseRemove(this, OperationPackage.CONTAINER__DEFAULT_BASIC_ENDPOINTS, de.fhdo.ddmm.operation.Container.class, msgs);
            case OperationPackage.BASIC_ENDPOINT__INFRASTRUCTURE_NODE:
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case OperationPackage.BASIC_ENDPOINT__PROTOCOLS:
                ...
                return;
            case OperationPackage.BASIC_ENDPOINT__CONTAINER:
                setContainer((de.fhdo.ddmm.operation.Container)newValue);
                return;
            case OperationPackage.BASIC_ENDPOINT__INFRASTRUCTURE_NODE:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case OperationPackage.BASIC_ENDPOINT__PROTOCOLS:
                ...
                return;
            case OperationPackage.BASIC_ENDPOINT__CONTAINER:
                setContainer((de.fhdo.ddmm.operation.Container)null);
                return;
            case OperationPackage.BASIC_ENDPOINT__INFRASTRUCTURE_NODE:
