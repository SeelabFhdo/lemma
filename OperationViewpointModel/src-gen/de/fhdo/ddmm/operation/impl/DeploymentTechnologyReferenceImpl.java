 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.operation.impl.DeploymentTechnologyReferenceImpl#getImport <em>Import</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.impl.DeploymentTechnologyReferenceImpl#getDeploymentTechnology <em>Deployment Technology</em>}</li>
 *   <li>{@link de.fhdo.ddmm.operation.impl.DeploymentTechnologyReferenceImpl#getContainer <em>Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentTechnologyReferenceImpl extends MinimalEObjectImpl.Container implements DeploymentTechnologyReference {
    ...
    public void setContainer(de.fhdo.ddmm.operation.Container newContainer) {
        if (newContainer != eInternalContainer() || (eContainerFeatureID() != OperationPackage.DEPLOYMENT_TECHNOLOGY_REFERENCE__CONTAINER && newContainer != null)) {
            ...
            if (newContainer != null)
                msgs = ((InternalEObject)newContainer).eInverseAdd(this, OperationPackage.CONTAINER__DEPLOYMENT_TECHNOLOGY, de.fhdo.ddmm.operation.Container.class, msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case OperationPackage.DEPLOYMENT_TECHNOLOGY_REFERENCE__CONTAINER:
                return eInternalContainer().eInverseRemove(this, OperationPackage.CONTAINER__DEPLOYMENT_TECHNOLOGY, de.fhdo.ddmm.operation.Container.class, msgs);
        }
