...
public abstract class AbstractContainerBaseGeneratorTemplate extends AbstractCodeGeneratorTemplate {
   ...
   * Constructor
   */
  public AbstractContainerBaseGeneratorTemplate(final ProcessorExecutableType generatorExecutableType, final Shell parentShell, final String name, final IProject project, final IFile file) {
