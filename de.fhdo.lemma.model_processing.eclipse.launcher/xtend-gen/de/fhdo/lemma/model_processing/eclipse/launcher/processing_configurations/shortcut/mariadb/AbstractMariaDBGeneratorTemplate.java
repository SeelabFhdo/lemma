...
/**
 * Abstract superclass for launch configuration templates targeting code generation with the MariaDB
 * Generator.
 * 
 * @author <a href="mailto:florian.rademacher@fh-dortmund.de">Florian Rademacher</a>
 */
@SuppressWarnings("all")
public abstract class AbstractMariaDBGeneratorTemplate extends AbstractCodeGeneratorTemplate {
  /**
   * Constructor
   */
  public AbstractMariaDBGeneratorTemplate(final ProcessorExecutableType generatorExecutableType, final Shell parentShell, final String name, final IProject project, final IFile file) {
    super(generatorExecutableType, parentShell, name, project, file);
  }
  
  /**
   * The template is applicable when the source operation model applies the MariaDB technology to
  ...
  public final Boolean isApplicable(final EObject modelRoot, final Map<String, String> technologyNamePerAlias) {
    ...
    final Function1<Import, Boolean> _function_1 = (Import it) -> {
      boolean _xblockexpression = false;
      {
        ...
        _xblockexpression = "mariadb".equalsIgnoreCase(technologyName);
      }
