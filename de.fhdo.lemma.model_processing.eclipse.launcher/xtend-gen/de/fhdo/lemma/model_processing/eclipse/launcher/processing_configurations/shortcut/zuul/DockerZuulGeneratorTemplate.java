...
/**
 * Launch configuration template targeting code generation with the Zuul Generator in a Docker
 * container based on a local image.
 * 
 * @author <a href="mailto:florian.rademacher@fh-dortmund.de">Florian Rademacher</a>
 */
@SuppressWarnings("all")
public final class DockerZuulGeneratorTemplate extends AbstractZuulGeneratorTemplate {
  /**
  ...
  public DockerZuulGeneratorTemplate(final Shell parentShell, final IProject project, final IFile file) {
    super(ProcessorExecutableType.LOCAL_DOCKER_IMAGE, parentShell, ("Docker-based Zuul " + 
