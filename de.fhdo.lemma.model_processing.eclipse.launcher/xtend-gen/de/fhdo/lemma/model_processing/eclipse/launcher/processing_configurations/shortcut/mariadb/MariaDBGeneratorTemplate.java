...
/**
 * Launch configuration template targeting code generation with the MariaDB Generator as a local
 * Java program.
 * 
 * @author <a href="mailto:florian.rademacher@fh-dortmund.de">Florian Rademacher</a>
 */
@SuppressWarnings("all")
public final class MariaDBGeneratorTemplate extends AbstractMariaDBGeneratorTemplate {
  /**
