...
/**
 * Launch configuration template targeting code generation with the MariaDB Generator in a Docker
 * container based on a local image.
 * 
 * @author <a href="mailto:florian.rademacher@fh-dortmund.de">Florian Rademacher</a>
 */
@SuppressWarnings("all")
public final class DockerMariaDBGeneratorTemplate extends AbstractMariaDBGeneratorTemplate {
  /**
  ...
  public static final class TemplateCompletionDialog extends AbstractCodeGeneratorCompletionDialog {
    ...
    public final void create() {
      super.create();
      this.setTitle("Generate MariaDB Artifacts From LEMMA Models Using Docker");
   ...
   * Constructor
   */
  public DockerMariaDBGeneratorTemplate(final Shell parentShell, final IProject project, final IFile file) {
  ...
  public final AbstractCodeGeneratorCompletionDialog getCodeGeneratorCompletionDialog() {
    return new DockerMariaDBGeneratorTemplate.TemplateCompletionDialog(this.parentShell, this.project, this.file);
  }
}
