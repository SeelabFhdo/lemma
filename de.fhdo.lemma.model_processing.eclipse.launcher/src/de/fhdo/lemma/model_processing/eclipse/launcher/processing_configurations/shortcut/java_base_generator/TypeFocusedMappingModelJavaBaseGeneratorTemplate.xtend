 ...
 */
final class TypeFocusedMappingModelJavaBaseGeneratorTemplate extends JavaBaseGeneratorTemplate {
    /**
     * Constructor
     */
    ...
    private static class TypeFocusedMappingModelTemplateCompletionDialog
         ...
         */
        final override insertAdditionalControlsBeforeGenletsGroup(Composite parent) {
