 ...
 */
final class ZuulGeneratorTemplate extends AbstractZuulGeneratorTemplate {
    /**
     * Constructor
     */
    new(Shell parentShell, IProject project, IFile file) {
        super(ProcessorExecutableType.LOCAL_JAVA_PROGRAM, parentShell, "Zuul artifact generation",
            project, file)
    }
