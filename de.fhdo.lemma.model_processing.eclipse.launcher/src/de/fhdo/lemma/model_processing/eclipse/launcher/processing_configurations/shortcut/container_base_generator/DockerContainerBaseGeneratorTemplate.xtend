...
/**
 * Launch configuration template targeting code generation with the Container Base Generator in a
 * Docker container based on a local image.
 *
 * @author <a href="mailto:florian.rademacher@fh-dortmund.de">Florian Rademacher</a>
 */
final class DockerContainerBaseGeneratorTemplate extends AbstractContainerBaseGeneratorTemplate {
    /**
     * Constructor
     */
    ...
    final override extendInitializedProcessingConfigurationTemplate(
        ...
        initializedConfiguration.processorExecutablePath = ContainerBaseGeneratorConstants
