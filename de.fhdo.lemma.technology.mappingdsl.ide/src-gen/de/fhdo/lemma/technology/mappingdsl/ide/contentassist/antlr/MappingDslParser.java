 ...
 */
package de.fhdo.lemma.technology.mappingdsl.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import de.fhdo.lemma.technology.mappingdsl.ide.contentassist.antlr.internal.InternalMappingDslParser;
...
public class MappingDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getAlternatives(), "rule__TechnologySpecificFieldMapping__Alternatives");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getAlternatives_1_2(), "rule__TechnologySpecificFieldMapping__Alternatives_1_2");
			builder.put(grammarAccess.getDataOperationMappingAccess().getAlternatives_2(), "rule__DataOperationMapping__Alternatives_2");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getAlternatives_2(), "rule__DataOperationReturnTypeMapping__Alternatives_2");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getAlternatives_2(), "rule__DataOperationParameterMapping__Alternatives_2");
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getAlternatives_3_1(), "rule__TechnologySpecificImportedServiceAspect__Alternatives_3_1");
			...
			builder.put(grammarAccess.getTechnologyMappingAccess().getGroup(), "rule__TechnologyMapping__Group__0");
			...
			builder.put(grammarAccess.getImportedComplexTypeToMapAccess().getGroup(), "rule__ImportedComplexTypeToMap__Group__0");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getGroup(), "rule__MicroserviceMapping__Group__0");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getGroup_3(), "rule__MicroserviceMapping__Group_3__0");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getGroup_4(), "rule__MicroserviceMapping__Group_4__0");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getGroup_5(), "rule__MicroserviceMapping__Group_5__0");
			builder.put(grammarAccess.getInterfaceMappingAccess().getGroup(), "rule__InterfaceMapping__Group__0");
			builder.put(grammarAccess.getInterfaceMappingAccess().getGroup_3(), "rule__InterfaceMapping__Group_3__0");
			builder.put(grammarAccess.getInterfaceMappingAccess().getGroup_4(), "rule__InterfaceMapping__Group_4__0");
			builder.put(grammarAccess.getInterfaceMappingAccess().getGroup_5(), "rule__InterfaceMapping__Group_5__0");
			builder.put(grammarAccess.getOperationMappingAccess().getGroup(), "rule__OperationMapping__Group__0");
			builder.put(grammarAccess.getOperationMappingAccess().getGroup_3(), "rule__OperationMapping__Group_3__0");
			...
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getGroup_0(), "rule__TechnologySpecificFieldMapping__Group_0__0");
			...
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getGroup_1_1(), "rule__TechnologySpecificFieldMapping__Group_1_1__0");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getGroup_1_2_0(), "rule__TechnologySpecificFieldMapping__Group_1_2_0__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup(), "rule__DataOperationMapping__Group__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_2_0(), "rule__DataOperationMapping__Group_2_0__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_2_0_1(), "rule__DataOperationMapping__Group_2_0_1__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_2_0_2(), "rule__DataOperationMapping__Group_2_0_2__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_2_0_3(), "rule__DataOperationMapping__Group_2_0_3__0");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getGroup(), "rule__DataOperationReturnTypeMapping__Group__0");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getGroup_1(), "rule__DataOperationReturnTypeMapping__Group_1__0");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getGroup_2_0(), "rule__DataOperationReturnTypeMapping__Group_2_0__0");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getGroup(), "rule__DataOperationParameterMapping__Group__0");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getGroup_1(), "rule__DataOperationParameterMapping__Group_1__0");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getGroup_2_0(), "rule__DataOperationParameterMapping__Group_2_0__0");
			...
			builder.put(grammarAccess.getTechnologySpecificProtocolAccess().getGroup_3(), "rule__TechnologySpecificProtocol__Group_3__0");
			builder.put(grammarAccess.getTechnologySpecificEndpointAccess().getGroup(), "rule__TechnologySpecificEndpoint__Group__0");
			builder.put(grammarAccess.getTechnologySpecificEndpointAccess().getGroup_1(), "rule__TechnologySpecificEndpoint__Group_1__0");
			...
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getGroup_3(), "rule__TechnologySpecificImportedServiceAspect__Group_3__0");
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getGroup_3_1_1(), "rule__TechnologySpecificImportedServiceAspect__Group_3_1_1__0");
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getGroup_3_1_1_1(), "rule__TechnologySpecificImportedServiceAspect__Group_3_1_1_1__0");
			...
			builder.put(grammarAccess.getTechnologyMappingAccess().getTypeMappingsAssignment_1(), "rule__TechnologyMapping__TypeMappingsAssignment_1");
			builder.put(grammarAccess.getTechnologyMappingAccess().getServiceMappingsAssignment_2(), "rule__TechnologyMapping__ServiceMappingsAssignment_2");
			builder.put(grammarAccess.getComplexTypeMappingAccess().getTechnologyReferencesAssignment_0(), "rule__ComplexTypeMapping__TechnologyReferencesAssignment_0");
			...
			builder.put(grammarAccess.getComplexTypeMappingAccess().getOperationMappingsAssignment_6(), "rule__ComplexTypeMapping__OperationMappingsAssignment_6");
			builder.put(grammarAccess.getImportedComplexTypeToMapAccess().getServiceModelImportAssignment_0(), "rule__ImportedComplexTypeToMap__ServiceModelImportAssignment_0");
			builder.put(grammarAccess.getImportedComplexTypeToMapAccess().getDataModelImportAssignment_2(), "rule__ImportedComplexTypeToMap__DataModelImportAssignment_2");
			builder.put(grammarAccess.getImportedComplexTypeToMapAccess().getTypeAssignment_4(), "rule__ImportedComplexTypeToMap__TypeAssignment_4");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getTechnologyReferencesAssignment_0(), "rule__MicroserviceMapping__TechnologyReferencesAssignment_0");
			...
			builder.put(grammarAccess.getMicroserviceMappingAccess().getEndpointsAssignment_4_2(), "rule__MicroserviceMapping__EndpointsAssignment_4_2");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getAspectsAssignment_5_2(), "rule__MicroserviceMapping__AspectsAssignment_5_2");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getInterfaceMappingsAssignment_6(), "rule__MicroserviceMapping__InterfaceMappingsAssignment_6");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getReferredOperationMappingsAssignment_7(), "rule__MicroserviceMapping__ReferredOperationMappingsAssignment_7");
			builder.put(grammarAccess.getMicroserviceMappingAccess().getOperationMappingsAssignment_8(), "rule__MicroserviceMapping__OperationMappingsAssignment_8");
			builder.put(grammarAccess.getInterfaceMappingAccess().getInterfaceAssignment_1(), "rule__InterfaceMapping__InterfaceAssignment_1");
			builder.put(grammarAccess.getInterfaceMappingAccess().getProtocolsAssignment_3_2(), "rule__InterfaceMapping__ProtocolsAssignment_3_2");
			builder.put(grammarAccess.getInterfaceMappingAccess().getEndpointsAssignment_4_2(), "rule__InterfaceMapping__EndpointsAssignment_4_2");
			builder.put(grammarAccess.getInterfaceMappingAccess().getAspectsAssignment_5_2(), "rule__InterfaceMapping__AspectsAssignment_5_2");
			builder.put(grammarAccess.getOperationMappingAccess().getOperationAssignment_1(), "rule__OperationMapping__OperationAssignment_1");
			builder.put(grammarAccess.getOperationMappingAccess().getProtocolsAssignment_3_2(), "rule__OperationMapping__ProtocolsAssignment_3_2");
			...
			builder.put(grammarAccess.getReferredOperationMappingAccess().getAspectsAssignment_6_2(), "rule__ReferredOperationMapping__AspectsAssignment_6_2");
			...
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getEnumerationFieldAssignment_0_1(), "rule__TechnologySpecificFieldMapping__EnumerationFieldAssignment_0_1");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getAspectsAssignment_0_5(), "rule__TechnologySpecificFieldMapping__AspectsAssignment_0_5");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getDataFieldAssignment_1_0(), "rule__TechnologySpecificFieldMapping__DataFieldAssignment_1_0");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getTechnologyAssignment_1_1_1(), "rule__TechnologySpecificFieldMapping__TechnologyAssignment_1_1_1");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getTypeAssignment_1_1_3(), "rule__TechnologySpecificFieldMapping__TypeAssignment_1_1_3");
			builder.put(grammarAccess.getTechnologySpecificFieldMappingAccess().getAspectsAssignment_1_2_0_3(), "rule__TechnologySpecificFieldMapping__AspectsAssignment_1_2_0_3");
			builder.put(grammarAccess.getDataOperationMappingAccess().getDataOperationAssignment_1(), "rule__DataOperationMapping__DataOperationAssignment_1");
			builder.put(grammarAccess.getDataOperationMappingAccess().getAspectsAssignment_2_0_1_2(), "rule__DataOperationMapping__AspectsAssignment_2_0_1_2");
			builder.put(grammarAccess.getDataOperationMappingAccess().getReturnTypeMappingAssignment_2_0_2_2(), "rule__DataOperationMapping__ReturnTypeMappingAssignment_2_0_2_2");
			builder.put(grammarAccess.getDataOperationMappingAccess().getParameterMappingsAssignment_2_0_3_2(), "rule__DataOperationMapping__ParameterMappingsAssignment_2_0_3_2");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getTechnologyAssignment_1_1(), "rule__DataOperationReturnTypeMapping__TechnologyAssignment_1_1");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getTypeAssignment_1_3(), "rule__DataOperationReturnTypeMapping__TypeAssignment_1_3");
			builder.put(grammarAccess.getDataOperationReturnTypeMappingAccess().getAspectsAssignment_2_0_3(), "rule__DataOperationReturnTypeMapping__AspectsAssignment_2_0_3");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getParameterAssignment_0(), "rule__DataOperationParameterMapping__ParameterAssignment_0");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getTechnologyAssignment_1_1(), "rule__DataOperationParameterMapping__TechnologyAssignment_1_1");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getTypeAssignment_1_3(), "rule__DataOperationParameterMapping__TypeAssignment_1_3");
			builder.put(grammarAccess.getDataOperationParameterMappingAccess().getAspectsAssignment_2_0_3(), "rule__DataOperationParameterMapping__AspectsAssignment_2_0_3");
			...
			builder.put(grammarAccess.getTechnologySpecificProtocolSpecificationAccess().getTechnologySpecificProtocolAssignment_2(), "rule__TechnologySpecificProtocolSpecification__TechnologySpecificProtocolAssignment_2");
			builder.put(grammarAccess.getTechnologySpecificProtocolAccess().getTechnologyAssignment_0(), "rule__TechnologySpecificProtocol__TechnologyAssignment_0");
			builder.put(grammarAccess.getTechnologySpecificProtocolAccess().getProtocolAssignment_2(), "rule__TechnologySpecificProtocol__ProtocolAssignment_2");
			builder.put(grammarAccess.getTechnologySpecificProtocolAccess().getDataFormatAssignment_3_1(), "rule__TechnologySpecificProtocol__DataFormatAssignment_3_1");
			builder.put(grammarAccess.getTechnologySpecificEndpointAccess().getTechnologySpecificProtocolsAssignment_0(), "rule__TechnologySpecificEndpoint__TechnologySpecificProtocolsAssignment_0");
			builder.put(grammarAccess.getTechnologySpecificEndpointAccess().getTechnologySpecificProtocolsAssignment_1_1(), "rule__TechnologySpecificEndpoint__TechnologySpecificProtocolsAssignment_1_1");
			builder.put(grammarAccess.getTechnologySpecificEndpointAccess().getAddressesAssignment_3(), "rule__TechnologySpecificEndpoint__AddressesAssignment_3");
			builder.put(grammarAccess.getTechnologySpecificEndpointAccess().getAddressesAssignment_4_1(), "rule__TechnologySpecificEndpoint__AddressesAssignment_4_1");
			...
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getSinglePropertyValueAssignment_3_1_0(), "rule__TechnologySpecificImportedServiceAspect__SinglePropertyValueAssignment_3_1_0");
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getValuesAssignment_3_1_1_0(), "rule__TechnologySpecificImportedServiceAspect__ValuesAssignment_3_1_1_0");
			builder.put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getValuesAssignment_3_1_1_1_1(), "rule__TechnologySpecificImportedServiceAspect__ValuesAssignment_3_1_1_1_1");
			...
			builder.put(grammarAccess.getApiParameterCommentAccess().getRequiredAssignment_0_2(), "rule__ApiParameterComment__RequiredAssignment_0_2");
			builder.put(grammarAccess.getApiParameterCommentAccess().getReturnedAssignment_0_3(), "rule__ApiParameterComment__ReturnedAssignment_0_3");
			builder.put(grammarAccess.getApiParameterCommentAccess().getReturnedAssignment_0_4(), "rule__ApiParameterComment__ReturnedAssignment_0_4");
