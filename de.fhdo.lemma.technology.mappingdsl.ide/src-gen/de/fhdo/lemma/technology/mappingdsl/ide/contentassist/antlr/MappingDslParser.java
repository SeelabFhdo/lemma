...
public class MappingDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMicroserviceAccess().getGroup_10(), "rule__Microservice__Group_10__0");
			builder.put(grammarAccess.getMicroserviceAccess().getGroup_10_4(), "rule__Microservice__Group_10_4__0");
			...
			builder.put(grammarAccess.getMicroserviceAccess().getAspectsAssignment_3(), "rule__Microservice__AspectsAssignment_3");
			builder.put(grammarAccess.getMicroserviceAccess().getVisibilityAssignment_4(), "rule__Microservice__VisibilityAssignment_4");
			builder.put(grammarAccess.getMicroserviceAccess().getTypeAssignment_5(), "rule__Microservice__TypeAssignment_5");
			builder.put(grammarAccess.getMicroserviceAccess().getNameAssignment_7(), "rule__Microservice__NameAssignment_7");
			builder.put(grammarAccess.getMicroserviceAccess().getVersionAssignment_8_1(), "rule__Microservice__VersionAssignment_8_1");
			builder.put(grammarAccess.getMicroserviceAccess().getRequiredMicroservicesAssignment_10_3(), "rule__Microservice__RequiredMicroservicesAssignment_10_3");
			builder.put(grammarAccess.getMicroserviceAccess().getRequiredMicroservicesAssignment_10_4_1(), "rule__Microservice__RequiredMicroservicesAssignment_10_4_1");
			builder.put(grammarAccess.getMicroserviceAccess().getRequiredInterfacesAssignment_11_3(), "rule__Microservice__RequiredInterfacesAssignment_11_3");
			builder.put(grammarAccess.getMicroserviceAccess().getRequiredInterfacesAssignment_11_4_1(), "rule__Microservice__RequiredInterfacesAssignment_11_4_1");
			...
			builder.put(grammarAccess.getInterfaceAccess().getAspectsAssignment_2(), "rule__Interface__AspectsAssignment_2");
			...
			builder.put(grammarAccess.getReferredOperationAccess().getAspectsAssignment_2(), "rule__ReferredOperation__AspectsAssignment_2");
			builder.put(grammarAccess.getReferredOperationAccess().getOperationAssignment_4(), "rule__ReferredOperation__OperationAssignment_4");
			...
			builder.put(grammarAccess.getServiceAspectAccess().getJoinPointsAssignment_3(), "rule__ServiceAspect__JoinPointsAssignment_3");
