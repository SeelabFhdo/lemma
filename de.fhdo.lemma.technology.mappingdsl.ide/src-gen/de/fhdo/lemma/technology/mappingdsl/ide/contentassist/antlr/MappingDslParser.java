...
public class MappingDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDataOperationMappingAccess().getAlternatives_3(), "rule__DataOperationMapping__Alternatives_3");
			...
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_2(), "rule__DataOperationMapping__Group_2__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_3_0(), "rule__DataOperationMapping__Group_3_0__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_3_0_1(), "rule__DataOperationMapping__Group_3_0_1__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_3_0_2(), "rule__DataOperationMapping__Group_3_0_2__0");
			...
			builder.put(grammarAccess.getDataOperationMappingAccess().getTechnologyAssignment_2_1(), "rule__DataOperationMapping__TechnologyAssignment_2_1");
			builder.put(grammarAccess.getDataOperationMappingAccess().getReturnTypeAssignment_2_3(), "rule__DataOperationMapping__ReturnTypeAssignment_2_3");
			builder.put(grammarAccess.getDataOperationMappingAccess().getAspectsAssignment_3_0_1_2(), "rule__DataOperationMapping__AspectsAssignment_3_0_1_2");
			builder.put(grammarAccess.getDataOperationMappingAccess().getParameterMappingsAssignment_3_0_2_2(), "rule__DataOperationMapping__ParameterMappingsAssignment_3_0_2_2");
