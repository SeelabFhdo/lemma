...
public class MappingDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDataOperationMappingAccess().getAlternatives(), "rule__DataOperationMapping__Alternatives");
			...
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_0(), "rule__DataOperationMapping__Group_0__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_0_2(), "rule__DataOperationMapping__Group_0_2__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_0_3(), "rule__DataOperationMapping__Group_0_3__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_0_3_1(), "rule__DataOperationMapping__Group_0_3_1__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_0_3_2(), "rule__DataOperationMapping__Group_0_3_2__0");
			builder.put(grammarAccess.getDataOperationMappingAccess().getGroup_1(), "rule__DataOperationMapping__Group_1__0");
			...
			builder.put(grammarAccess.getDataFieldAccess().getGroup_4_2(), "rule__DataField__Group_4_2__0");
			...
			builder.put(grammarAccess.getDataOperationMappingAccess().getDataOperationAssignment_0_1(), "rule__DataOperationMapping__DataOperationAssignment_0_1");
			builder.put(grammarAccess.getDataOperationMappingAccess().getTechnologyAssignment_0_2_1(), "rule__DataOperationMapping__TechnologyAssignment_0_2_1");
			builder.put(grammarAccess.getDataOperationMappingAccess().getReturnTypeAssignment_0_2_3(), "rule__DataOperationMapping__ReturnTypeAssignment_0_2_3");
			builder.put(grammarAccess.getDataOperationMappingAccess().getAspectsAssignment_0_3_1_2(), "rule__DataOperationMapping__AspectsAssignment_0_3_1_2");
			builder.put(grammarAccess.getDataOperationMappingAccess().getParameterMappingsAssignment_0_3_2_2(), "rule__DataOperationMapping__ParameterMappingsAssignment_0_3_2_2");
			...
			builder.put(grammarAccess.getDataFieldAccess().getFeaturesAssignment_4_1(), "rule__DataField__FeaturesAssignment_4_1");
			builder.put(grammarAccess.getDataFieldAccess().getFeaturesAssignment_4_2_1(), "rule__DataField__FeaturesAssignment_4_2_1");
