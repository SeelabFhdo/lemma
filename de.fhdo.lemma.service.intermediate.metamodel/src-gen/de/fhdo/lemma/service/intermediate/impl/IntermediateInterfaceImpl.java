 ...
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#isHasImplementedOperations <em>Has Implemented Operations</em>}</li>
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#getReferredOperations <em>Referred Operations</em>}</li>
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#getAspects <em>Aspects</em>}</li>
 *   <li>{@link de.fhdo.lemma.service.intermediate.impl.IntermediateInterfaceImpl#getMicroservice <em>Microservice</em>}</li>
 * </ul>
 *
 * @generated
 */
