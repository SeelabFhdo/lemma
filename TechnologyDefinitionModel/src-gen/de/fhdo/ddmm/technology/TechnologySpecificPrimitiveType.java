 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#getName <em>Name</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#isDefault <em>Default</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#getTechnology <em>Technology</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#getBasicBuiltinPrimitiveTypes <em>Basic Builtin Primitive Types</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.technology.TechnologyPackage#getTechnologySpecificPrimitiveType()
 * @model
 * @generated
 */
public interface TechnologySpecificPrimitiveType extends PrimitiveType {
     ...
     * @see #setName(String)
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_Name()
     * @model unique="false"
     * @generated
     */
    String getName();
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_Default()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#isDefault <em>Default</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.Technology#getPrimitiveTypes <em>Primitive Types</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_Technology()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.TechnologySpecificPrimitiveType#getTechnology <em>Technology</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link de.fhdo.ddmm.data.PrimitiveType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getTechnologySpecificPrimitiveType_BasicBuiltinPrimitiveTypes()
