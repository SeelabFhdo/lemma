 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getDirection <em>Direction</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getMappingType <em>Mapping Type</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getCompatibleTypes <em>Compatible Types</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getTechnology <em>Technology</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.technology.TechnologyPackage#getCompatibilityMatrixEntry()
 * @model
 * @generated
 */
public interface CompatibilityMatrixEntry extends EObject {
     ...
     * The literals are from the enumeration {@link de.fhdo.ddmm.technology.CompatibilityDirection}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * *
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getCompatibilityMatrixEntry_Direction()
     * @model unique="false"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getDirection <em>Direction</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.PossiblyImportedTechnologySpecificType#getMappingEntry <em>Mapping Entry</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getCompatibilityMatrixEntry_MappingType()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getMappingType <em>Mapping Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link de.fhdo.ddmm.technology.PossiblyImportedTechnologySpecificType}.
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.PossiblyImportedTechnologySpecificType#getCompatibleEntry <em>Compatible Entry</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getCompatibilityMatrixEntry_CompatibleTypes()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.Technology#getCompatibilityEntries <em>Compatibility Entries</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getCompatibilityMatrixEntry_Technology()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.CompatibilityMatrixEntry#getTechnology <em>Technology</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
