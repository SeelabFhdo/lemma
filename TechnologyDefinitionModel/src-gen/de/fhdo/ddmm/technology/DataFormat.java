 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.DataFormat#getFormatName <em>Format Name</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.DataFormat#getProtocol <em>Protocol</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.technology.TechnologyPackage#getDataFormat()
 * @model
 * @generated
 */
public interface DataFormat extends EObject {
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getDataFormat_FormatName()
     * @model unique="false"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.DataFormat#getFormatName <em>Format Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.Protocol#getDataFormats <em>Data Formats</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.TechnologyPackage#getDataFormat_Protocol()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.DataFormat#getProtocol <em>Protocol</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
