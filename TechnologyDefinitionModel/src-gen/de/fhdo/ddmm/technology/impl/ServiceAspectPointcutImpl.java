 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#isForExchangePattern <em>For Exchange Pattern</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#isForCommunicationType <em>For Communication Type</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#isForProtocol <em>For Protocol</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#isForDataFormat <em>For Data Format</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getExchangePattern <em>Exchange Pattern</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getCommunicationType <em>Communication Type</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getDataFormat <em>Data Format</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getEffectiveType <em>Effective Type</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getEffectiveSelectorName <em>Effective Selector Name</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getEffectiveValue <em>Effective Value</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getPrintableEffectiveValue <em>Printable Effective Value</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.impl.ServiceAspectPointcutImpl#getOrderedPointcutTypes <em>Ordered Pointcut Types</em>}</li>
 * </ul>
 *
 * @generated
 */
