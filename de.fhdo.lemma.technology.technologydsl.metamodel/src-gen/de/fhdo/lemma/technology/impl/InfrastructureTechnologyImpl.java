 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.lemma.technology.impl.InfrastructureTechnologyImpl#getTechnology <em>Technology</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InfrastructureTechnologyImpl extends OperationTechnologyImpl implements InfrastructureTechnology {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected InfrastructureTechnologyImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return TechnologyPackage.Literals.INFRASTRUCTURE_TECHNOLOGY;
    }
    ...
    public NotificationChain basicSetTechnology(Technology newTechnology, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject)newTechnology, TechnologyPackage.INFRASTRUCTURE_TECHNOLOGY__TECHNOLOGY, msgs);
        return msgs;
    }
    ...
    public void setTechnology(Technology newTechnology) {
        if (newTechnology != eInternalContainer() || (eContainerFeatureID() != TechnologyPackage.INFRASTRUCTURE_TECHNOLOGY__TECHNOLOGY && newTechnology != null)) {
            ...
            if (newTechnology != null)
                msgs = ((InternalEObject)newTechnology).eInverseAdd(this, TechnologyPackage.TECHNOLOGY__INFRASTRUCTURE_TECHNOLOGIES, Technology.class, msgs);
    ...
    public String buildQualifiedName(final String separator, final boolean withTechnologyName, final boolean withNamespace) {
        ...
        if (withNamespace) {
            ...
            qualifiedName = (_qualifiedName_2 + "_infrastructure");
        }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case TechnologyPackage.INFRASTRUCTURE_TECHNOLOGY__TECHNOLOGY:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch (eContainerFeatureID()) {
            case TechnologyPackage.INFRASTRUCTURE_TECHNOLOGY__TECHNOLOGY:
                return eInternalContainer().eInverseRemove(this, TechnologyPackage.TECHNOLOGY__INFRASTRUCTURE_TECHNOLOGIES, Technology.class, msgs);
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            ...
            case TechnologyPackage.INFRASTRUCTURE_TECHNOLOGY___BUILD_QUALIFIED_NAME__STRING_BOOLEAN_BOOLEAN:
