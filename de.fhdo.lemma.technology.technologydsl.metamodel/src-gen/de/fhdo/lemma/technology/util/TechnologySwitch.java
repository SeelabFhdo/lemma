...
public class TechnologySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TechnologyPackage.TECHNOLOGY_SPECIFIC_LIST_TYPE: {
				TechnologySpecificListType technologySpecificListType = (TechnologySpecificListType)theEObject;
				T result = caseTechnologySpecificListType(technologySpecificListType);
				if (result == null) result = caseComplexType(technologySpecificListType);
				if (result == null) result = caseType(technologySpecificListType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Specific List Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Specific List Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTechnologySpecificListType(TechnologySpecificListType object) {
		return null;
	}
