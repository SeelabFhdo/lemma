...
public interface OperationPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING = 1;
	 ...
	 * @ordered
	 */
	int OPERATION_NODE_OPERATION_COUNT = 2;
	 ...
	 * @ordered
	 */
	int CONTAINER___BUILD_QUALIFIED_NAME__STRING = OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING;
	 ...
	 * @ordered
	 */
	int INFRASTRUCTURE_NODE___BUILD_QUALIFIED_NAME__STRING = OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING;
	 ...
	 * @ordered
	 */
	int POSSIBLY_IMPORTED_OPERATION_NODE___GET_QUALIFIED_NAME_PARTS = 1;
	 ...
	 * @ordered
	 */
	int POSSIBLY_IMPORTED_OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING = 2;
	 ...
	 * @ordered
	 */
	int POSSIBLY_IMPORTED_OPERATION_NODE_OPERATION_COUNT = 3;
	...
	/**
	 * Returns the meta object for the '{@link de.fhdo.lemma.operation.OperationNode#buildQualifiedName(java.lang.String) <em>Build Qualified Name</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Build Qualified Name</em>' operation.
	 * @see de.fhdo.lemma.operation.OperationNode#buildQualifiedName(java.lang.String)
	 * @generated
	 */
	EOperation getOperationNode__BuildQualifiedName__String();
	...
	/**
	 * Returns the meta object for the '{@link de.fhdo.lemma.operation.PossiblyImportedOperationNode#getQualifiedNameParts() <em>Get Qualified Name Parts</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Qualified Name Parts</em>' operation.
	 * @see de.fhdo.lemma.operation.PossiblyImportedOperationNode#getQualifiedNameParts()
	 * @generated
	 */
	EOperation getPossiblyImportedOperationNode__GetQualifiedNameParts();

	/**
	 * Returns the meta object for the '{@link de.fhdo.lemma.operation.PossiblyImportedOperationNode#buildQualifiedName(java.lang.String) <em>Build Qualified Name</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Build Qualified Name</em>' operation.
	 * @see de.fhdo.lemma.operation.PossiblyImportedOperationNode#buildQualifiedName(java.lang.String)
	 * @generated
	 */
	EOperation getPossiblyImportedOperationNode__BuildQualifiedName__String();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING = eINSTANCE.getOperationNode__BuildQualifiedName__String();
		 ...
		 * @generated
		 */
		EOperation POSSIBLY_IMPORTED_OPERATION_NODE___GET_QUALIFIED_NAME_PARTS = eINSTANCE.getPossiblyImportedOperationNode__GetQualifiedNameParts();
		 ...
		 * @generated
		 */
		EOperation POSSIBLY_IMPORTED_OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING = eINSTANCE.getPossiblyImportedOperationNode__BuildQualifiedName__String();
