...
public interface OperationPackage extends EPackage {
    ...
    /**
     * The meta object id for the '{@link de.fhdo.lemma.operation.ImportType <em>Import Type</em>}' enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.fhdo.lemma.operation.ImportType
     * @see de.fhdo.lemma.operation.impl.OperationPackageImpl#getImportType()
     * @generated
     */
    int IMPORT_TYPE = 11;
    ...
    /**
     * Returns the meta object for the reference list '{@link de.fhdo.lemma.operation.InfrastructureNode#getUsedByNodes <em>Used By Nodes</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the reference list '<em>Used By Nodes</em>'.
     * @see de.fhdo.lemma.operation.InfrastructureNode#getUsedByNodes()
    ...
    /**
     * Returns the meta object for the reference list '{@link de.fhdo.lemma.operation.InfrastructureNode#getDependsOnNodes <em>Depends On Nodes</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the reference list '<em>Depends On Nodes</em>'.
     * @see de.fhdo.lemma.operation.InfrastructureNode#getDependsOnNodes()
     * @see #getInfrastructureNode()
     * @generated
     */
    ...
    /**
     * Returns the meta object for enum '{@link de.fhdo.lemma.operation.ImportType <em>Import Type</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '{@link de.fhdo.lemma.operation.ImportType <em>Import Type</em>}' enum.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see de.fhdo.lemma.operation.ImportType
         * @see de.fhdo.lemma.operation.impl.OperationPackageImpl#getImportType()
