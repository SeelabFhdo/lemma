...
public class OperationPackageImpl extends EPackageImpl implements OperationPackage {
	 ...
	 * @generated
	 */
	private EClass possiblyImportedOperationNodeEClass = null;
	 ...
	 * @see de.fhdo.lemma.operation.OperationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getOperationModel_T_modelUri() {
		return (EAttribute)operationModelEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getOperationModel_InfrastructureNodes() {
		return (EReference)operationModelEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getOperationNode_UsedByNodes() {
		return (EReference)operationNodeEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 */
	@Override
	public EReference getOperationNode_DependsOnNodes() {
		return (EReference)operationNodeEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 */
	@Override
	public EOperation getOperationNode__GetQualifiedNameParts() {
		return operationNodeEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getOperationNode__BuildQualifiedName__String() {
		return operationNodeEClass.getEOperations().get(1);
	}
	 ...
	 */
	@Override
	public EClass getPossiblyImportedOperationNode() {
		return possiblyImportedOperationNodeEClass;
	}
	 ...
	 */
	@Override
	public EReference getPossiblyImportedOperationNode_Import() {
		return (EReference)possiblyImportedOperationNodeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getPossiblyImportedOperationNode_Node() {
		return (EReference)possiblyImportedOperationNodeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getPossiblyImportedOperationNode__GetTechnologyName__OperationNode() {
		return possiblyImportedOperationNodeEClass.getEOperations().get(0);
	}
	 ...
	 */
	@Override
	public EOperation getPossiblyImportedOperationNode__GetQualifiedNameParts() {
		return possiblyImportedOperationNodeEClass.getEOperations().get(1);
	}
	 ...
	 */
	@Override
	public EOperation getPossiblyImportedOperationNode__BuildQualifiedName__String() {
		return possiblyImportedOperationNodeEClass.getEOperations().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(operationModelEClass, OPERATION_MODEL__TMODEL_URI);
		...
		createEReference(operationNodeEClass, OPERATION_NODE__USED_BY_NODES);
		createEReference(operationNodeEClass, OPERATION_NODE__DEPENDS_ON_NODES);
		createEOperation(operationNodeEClass, OPERATION_NODE___GET_QUALIFIED_NAME_PARTS);
		createEOperation(operationNodeEClass, OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING);
		...
		possiblyImportedOperationNodeEClass = createEClass(POSSIBLY_IMPORTED_OPERATION_NODE);
		createEReference(possiblyImportedOperationNodeEClass, POSSIBLY_IMPORTED_OPERATION_NODE__IMPORT);
		createEReference(possiblyImportedOperationNodeEClass, POSSIBLY_IMPORTED_OPERATION_NODE__NODE);
		createEOperation(possiblyImportedOperationNodeEClass, POSSIBLY_IMPORTED_OPERATION_NODE___GET_TECHNOLOGY_NAME__OPERATIONNODE);
		createEOperation(possiblyImportedOperationNodeEClass, POSSIBLY_IMPORTED_OPERATION_NODE___GET_QUALIFIED_NAME_PARTS);
		createEOperation(possiblyImportedOperationNodeEClass, POSSIBLY_IMPORTED_OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOperationModel_T_modelUri(), theEcorePackage.getEString(), "t_modelUri", null, 0, 1, OperationModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperationNode_UsedByNodes(), this.getPossiblyImportedOperationNode(), null, "usedByNodes", null, 0, -1, OperationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperationNode_DependsOnNodes(), this.getPossiblyImportedOperationNode(), null, "dependsOnNodes", null, 0, -1, OperationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getOperationNode__GetQualifiedNameParts(), theEcorePackage.getEString(), "getQualifiedNameParts", 0, -1, !IS_UNIQUE, IS_ORDERED);

		EOperation op = initEOperation(getOperationNode__BuildQualifiedName__String(), theEcorePackage.getEString(), "buildQualifiedName", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "separator", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEClass(containerEClass, de.fhdo.lemma.operation.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_DeploymentTechnology(), this.getDeploymentTechnologyReference(), this.getDeploymentTechnologyReference_Container(), "deploymentTechnology", null, 0, 1, de.fhdo.lemma.operation.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_DefaultBasicEndpoints(), this.getBasicEndpoint(), this.getBasicEndpoint_Container(), "defaultBasicEndpoints", null, 0, -1, de.fhdo.lemma.operation.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_OperationModel(), this.getOperationModel(), this.getOperationModel_Containers(), "operationModel", null, 0, 1, de.fhdo.lemma.operation.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(possiblyImportedOperationNodeEClass, PossiblyImportedOperationNode.class, "PossiblyImportedOperationNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPossiblyImportedOperationNode_Import(), theServicePackage.getImport(), null, "import", null, 0, 1, PossiblyImportedOperationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPossiblyImportedOperationNode_Node(), this.getOperationNode(), null, "node", null, 0, 1, PossiblyImportedOperationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getPossiblyImportedOperationNode__GetTechnologyName__OperationNode(), theEcorePackage.getEString(), "getTechnologyName", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getOperationNode(), "node", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEOperation(getPossiblyImportedOperationNode__GetQualifiedNameParts(), theEcorePackage.getEString(), "getQualifiedNameParts", 0, -1, !IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getPossiblyImportedOperationNode__BuildQualifiedName__String(), theEcorePackage.getEString(), "buildQualifiedName", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "separator", 0, 1, !IS_UNIQUE, IS_ORDERED);
