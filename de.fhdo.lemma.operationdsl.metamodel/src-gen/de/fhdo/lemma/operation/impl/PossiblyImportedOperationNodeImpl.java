...
public class PossiblyImportedOperationNodeImpl extends MinimalEObjectImpl.Container implements PossiblyImportedOperationNode {
    ...
    public EList<String> getQualifiedNameParts() {
        EList<String> _xblockexpression = null;
        {
            ...
            final String importUri = _elvis;
            boolean _isEmpty = importUri.isEmpty();
            boolean _not = (!_isEmpty);
            if (_not) {
                nameParts.add(importUri);
            }
            nameParts.addAll(this.getNode().getQualifiedNameParts());
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            ...
            case OperationPackage.POSSIBLY_IMPORTED_OPERATION_NODE___GET_QUALIFIED_NAME_PARTS:
                return getQualifiedNameParts();
            case OperationPackage.POSSIBLY_IMPORTED_OPERATION_NODE___BUILD_QUALIFIED_NAME__STRING:
