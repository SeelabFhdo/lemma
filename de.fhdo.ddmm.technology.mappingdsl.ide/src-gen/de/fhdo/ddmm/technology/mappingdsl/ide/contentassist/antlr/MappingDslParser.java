		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getAlternatives_1(), "rule__TechnologySpecificImportedServiceAspect__Alternatives_1");
					put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getAlternatives_1_0_1(), "rule__TechnologySpecificImportedServiceAspect__Alternatives_1_0_1");
					...
					put(grammarAccess.getMicroserviceMappingAccess().getGroup_7(), "rule__MicroserviceMapping__Group_7__0");
					put(grammarAccess.getMicroserviceMappingAccess().getGroup_8(), "rule__MicroserviceMapping__Group_8__0");
					put(grammarAccess.getMicroserviceMappingAccess().getGroup_9(), "rule__MicroserviceMapping__Group_9__0");
					...
					put(grammarAccess.getPrimitiveParameterMappingAccess().getGroup_4(), "rule__PrimitiveParameterMapping__Group_4__0");
					...
					put(grammarAccess.getComplexParameterMappingAccess().getGroup_2_0_2(), "rule__ComplexParameterMapping__Group_2_0_2__0");
					...
					put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getGroup_3(), "rule__TechnologySpecificDataFieldTypeMapping__Group_3__0");
					...
					put(grammarAccess.getTechnologySpecificProtocolAccess().getGroup_1(), "rule__TechnologySpecificProtocol__Group_1__0");
					...
					put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getGroup_1_0(), "rule__TechnologySpecificImportedServiceAspect__Group_1_0__0");
					...
					put(grammarAccess.getMicroserviceMappingAccess().getTechnologyAssignment_3(), "rule__MicroserviceMapping__TechnologyAssignment_3");
					put(grammarAccess.getMicroserviceMappingAccess().getMicroserviceAssignment_5(), "rule__MicroserviceMapping__MicroserviceAssignment_5");
					put(grammarAccess.getMicroserviceMappingAccess().getProtocolsAssignment_7_2(), "rule__MicroserviceMapping__ProtocolsAssignment_7_2");
					put(grammarAccess.getMicroserviceMappingAccess().getEndpointsAssignment_8_2(), "rule__MicroserviceMapping__EndpointsAssignment_8_2");
					put(grammarAccess.getMicroserviceMappingAccess().getAspectsAssignment_9_2(), "rule__MicroserviceMapping__AspectsAssignment_9_2");
					put(grammarAccess.getMicroserviceMappingAccess().getInterfaceMappingsAssignment_10(), "rule__MicroserviceMapping__InterfaceMappingsAssignment_10");
					put(grammarAccess.getMicroserviceMappingAccess().getReferredOperationMappingsAssignment_11(), "rule__MicroserviceMapping__ReferredOperationMappingsAssignment_11");
					put(grammarAccess.getMicroserviceMappingAccess().getOperationMappingsAssignment_12(), "rule__MicroserviceMapping__OperationMappingsAssignment_12");
					...
					put(grammarAccess.getPrimitiveParameterMappingAccess().getPrimitiveTypeAssignment_3(), "rule__PrimitiveParameterMapping__PrimitiveTypeAssignment_3");
					put(grammarAccess.getPrimitiveParameterMappingAccess().getAspectsAssignment_4_3(), "rule__PrimitiveParameterMapping__AspectsAssignment_4_3");
					...
					put(grammarAccess.getComplexParameterMappingAccess().getTechnologySpecificComplexTypeAssignment_2_0_1(), "rule__ComplexParameterMapping__TechnologySpecificComplexTypeAssignment_2_0_1");
					put(grammarAccess.getComplexParameterMappingAccess().getAspectsAssignment_2_0_2_3(), "rule__ComplexParameterMapping__AspectsAssignment_2_0_2_3");
					...
					put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getTypeAssignment_2(), "rule__TechnologySpecificDataFieldTypeMapping__TypeAssignment_2");
					put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getAspectsAssignment_3_3(), "rule__TechnologySpecificDataFieldTypeMapping__AspectsAssignment_3_3");
					...
					put(grammarAccess.getTechnologySpecificProtocolAccess().getProtocolAssignment_0(), "rule__TechnologySpecificProtocol__ProtocolAssignment_0");
					put(grammarAccess.getTechnologySpecificProtocolAccess().getDataFormatAssignment_1_1(), "rule__TechnologySpecificProtocol__DataFormatAssignment_1_1");
					...
					put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getImportedAspectAssignment_0(), "rule__TechnologySpecificImportedServiceAspect__ImportedAspectAssignment_0");
					put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getSinglePropertyValueAssignment_1_0_1_0(), "rule__TechnologySpecificImportedServiceAspect__SinglePropertyValueAssignment_1_0_1_0");
					put(grammarAccess.getTechnologySpecificImportedServiceAspectAccess().getValuesAssignment_1_0_1_1(), "rule__TechnologySpecificImportedServiceAspect__ValuesAssignment_1_0_1_1");
