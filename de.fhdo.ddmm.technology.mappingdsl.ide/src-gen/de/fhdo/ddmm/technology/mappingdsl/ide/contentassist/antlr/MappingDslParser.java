...
public class MappingDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPrimitiveParameterMappingAccess().getGroup_6(), "rule__PrimitiveParameterMapping__Group_6__0");
			...
			builder.put(grammarAccess.getComplexParameterMappingAccess().getGroup_2_0_4(), "rule__ComplexParameterMapping__Group_2_0_4__0");
			...
			builder.put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getGroup(), "rule__TechnologySpecificDataFieldTypeMapping__Group__0");
			builder.put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getGroup_5(), "rule__TechnologySpecificDataFieldTypeMapping__Group_5__0");
			builder.put(grammarAccess.getDataFieldHierarchyAccess().getGroup(), "rule__DataFieldHierarchy__Group__0");
			builder.put(grammarAccess.getDataFieldHierarchyAccess().getGroup_1(), "rule__DataFieldHierarchy__Group_1__0");
			...
			builder.put(grammarAccess.getPrimitiveParameterMappingAccess().getTechnologyAssignment_3(), "rule__PrimitiveParameterMapping__TechnologyAssignment_3");
			builder.put(grammarAccess.getPrimitiveParameterMappingAccess().getPrimitiveTypeAssignment_5(), "rule__PrimitiveParameterMapping__PrimitiveTypeAssignment_5");
			builder.put(grammarAccess.getPrimitiveParameterMappingAccess().getAspectsAssignment_6_3(), "rule__PrimitiveParameterMapping__AspectsAssignment_6_3");
			...
			builder.put(grammarAccess.getComplexParameterMappingAccess().getTechnologyAssignment_2_0_1(), "rule__ComplexParameterMapping__TechnologyAssignment_2_0_1");
			builder.put(grammarAccess.getComplexParameterMappingAccess().getTechnologySpecificComplexTypeAssignment_2_0_3(), "rule__ComplexParameterMapping__TechnologySpecificComplexTypeAssignment_2_0_3");
			builder.put(grammarAccess.getComplexParameterMappingAccess().getAspectsAssignment_2_0_4_3(), "rule__ComplexParameterMapping__AspectsAssignment_2_0_4_3");
			...
			builder.put(grammarAccess.getComplexParameterMappingAccess().getDataFieldMappingsAssignment_2_1_3(), "rule__ComplexParameterMapping__DataFieldMappingsAssignment_2_1_3");
			builder.put(grammarAccess.getComplexParameterMappingAccess().getDataFieldMappingsAssignment_2_1_4_1(), "rule__ComplexParameterMapping__DataFieldMappingsAssignment_2_1_4_1");
			builder.put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getDataFieldHierarchyAssignment_0(), "rule__TechnologySpecificDataFieldTypeMapping__DataFieldHierarchyAssignment_0");
			builder.put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getTechnologyAssignment_2(), "rule__TechnologySpecificDataFieldTypeMapping__TechnologyAssignment_2");
			builder.put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getTypeAssignment_4(), "rule__TechnologySpecificDataFieldTypeMapping__TypeAssignment_4");
			builder.put(grammarAccess.getTechnologySpecificDataFieldTypeMappingAccess().getAspectsAssignment_5_3(), "rule__TechnologySpecificDataFieldTypeMapping__AspectsAssignment_5_3");
			builder.put(grammarAccess.getDataFieldHierarchyAccess().getDataFieldsAssignment_0(), "rule__DataFieldHierarchy__DataFieldsAssignment_0");
			builder.put(grammarAccess.getDataFieldHierarchyAccess().getDataFieldsAssignment_1_2(), "rule__DataFieldHierarchy__DataFieldsAssignment_1_2");
