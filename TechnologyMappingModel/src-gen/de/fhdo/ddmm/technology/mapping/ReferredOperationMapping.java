 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getOperation <em>Operation</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getAspects <em>Aspects</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getMicroserviceMapping <em>Microservice Mapping</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getReferredOperationMapping()
 * @model
 * @generated
 */
public interface ReferredOperationMapping extends EObject {
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getReferredOperationMapping_Operation()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getOperation <em>Operation</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.TechnologySpecificEndpoint#getReferredOperationMapping <em>Referred Operation Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getReferredOperationMapping_Endpoints()
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getReferredOperationMapping_Protocols()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.TechnologySpecificImportedServiceAspect#getReferredOperationMapping <em>Referred Operation Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getReferredOperationMapping_Aspects()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.MicroserviceMapping#getReferredOperationMappings <em>Referred Operation Mappings</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getReferredOperationMapping_MicroserviceMapping()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.mapping.ReferredOperationMapping#getMicroserviceMapping <em>Microservice Mapping</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
