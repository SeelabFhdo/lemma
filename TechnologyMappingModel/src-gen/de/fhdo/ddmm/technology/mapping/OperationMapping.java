 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getOperation <em>Operation</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getParameterMappings <em>Parameter Mappings</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getAspects <em>Aspects</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getMicroserviceMapping <em>Microservice Mapping</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping()
 * @model
 * @generated
 */
public interface OperationMapping extends EObject {
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping_Operation()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getOperation <em>Operation</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.TechnologySpecificEndpoint#getOperationMapping <em>Operation Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping_Endpoints()
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping_Protocols()
     ...
     * The list contents are of type {@link de.fhdo.ddmm.technology.mapping.ParameterMapping}.
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.ParameterMapping#getOperationMapping <em>Operation Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping_ParameterMappings()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.TechnologySpecificImportedServiceAspect#getOperationMapping <em>Operation Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping_Aspects()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.MicroserviceMapping#getOperationMappings <em>Operation Mappings</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getOperationMapping_MicroserviceMapping()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.mapping.OperationMapping#getMicroserviceMapping <em>Microservice Mapping</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
