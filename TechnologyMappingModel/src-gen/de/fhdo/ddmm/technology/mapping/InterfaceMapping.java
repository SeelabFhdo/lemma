 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getInterface <em>Interface</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getEndpoints <em>Endpoints</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getProtocols <em>Protocols</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getAspects <em>Aspects</em>}</li>
 *   <li>{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getMicroserviceMapping <em>Microservice Mapping</em>}</li>
 * </ul>
 *
 * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getInterfaceMapping()
 * @model
 * @generated
 */
public interface InterfaceMapping extends EObject {
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getInterfaceMapping_Interface()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getInterface <em>Interface</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.TechnologySpecificEndpoint#getInterfaceMapping <em>Interface Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getInterfaceMapping_Endpoints()
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getInterfaceMapping_Protocols()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.TechnologySpecificImportedServiceAspect#getInterfaceMapping <em>Interface Mapping</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getInterfaceMapping_Aspects()
     ...
     * It is bidirectional and its opposite is '{@link de.fhdo.ddmm.technology.mapping.MicroserviceMapping#getInterfaceMappings <em>Interface Mappings</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see de.fhdo.ddmm.technology.mapping.MappingPackage#getInterfaceMapping_MicroserviceMapping()
    ...
    /**
     * Sets the value of the '{@link de.fhdo.ddmm.technology.mapping.InterfaceMapping#getMicroserviceMapping <em>Microservice Mapping</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
