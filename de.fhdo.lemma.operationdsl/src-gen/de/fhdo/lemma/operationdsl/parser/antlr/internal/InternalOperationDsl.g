...
entryRuleOperationModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getOperationModelRule()); }
	iv_ruleOperationModel=ruleOperationModel
	{ $current=$iv_ruleOperationModel.current; }
	EOF;

// Rule OperationModel
ruleOperationModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDeploymentTechnologyReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleDeploymentTechnologyReference.current; }
	EOF;

// Rule DeploymentTechnologyReference
ruleDeploymentTechnologyReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleInfrastructureNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInfrastructureNodeRule()); }
	iv_ruleInfrastructureNode=ruleInfrastructureNode
	{ $current=$iv_ruleInfrastructureNode.current; }
	EOF;

// Rule InfrastructureNode
ruleInfrastructureNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleInfrastructureTechnologyReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleInfrastructureTechnologyReference.current; }
	EOF;

// Rule InfrastructureTechnologyReference
ruleInfrastructureTechnologyReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleProtocolAndDataFormat returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getProtocolAndDataFormatRule()); }
	iv_ruleProtocolAndDataFormat=ruleProtocolAndDataFormat
	{ $current=$iv_ruleProtocolAndDataFormat.current; }
	EOF;

// Rule ProtocolAndDataFormat
ruleProtocolAndDataFormat returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleBasicEndpoint returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBasicEndpointRule()); }
	iv_ruleBasicEndpoint=ruleBasicEndpoint
	{ $current=$iv_ruleBasicEndpoint.current; }
	EOF;

// Rule BasicEndpoint
ruleBasicEndpoint returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleServiceDeploymentSpecification returns [EObject current=null]:
	...
	{ $current=$iv_ruleServiceDeploymentSpecification.current; }
	EOF;

// Rule ServiceDeploymentSpecification
ruleServiceDeploymentSpecification returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleImportedOperationAspect returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getImportedOperationAspectRule()); }
	iv_ruleImportedOperationAspect=ruleImportedOperationAspect
	{ $current=$iv_ruleImportedOperationAspect.current; }
	EOF;

// Rule ImportedOperationAspect
ruleImportedOperationAspect returns [EObject current=null]
@init {
	enterRule();
}
@after {
