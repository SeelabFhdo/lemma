...
import de.fhdo.ddmm.eclipse.ui.editor.ConnectThread;
...
public class ConnectProgressDialog extends TitleAreaDialog {
  ...
  public Control createDialogArea(final Composite parent) {
    ...
    progressTitleLabel.setImage(
      DdmmUiUtils.createImage(ConnectProgressDialog.RESOURCE_MANAGER, "connectLiveValidationServer.gif"));
  ...
  public int openAndConnectToServer() {
    ...
    final Function<Void, Void> _function = new Function<Void, Void>() {
      public Void apply(final Void it) {
        return ConnectProgressDialog.this.internalConnectedCallback();
      }
    };
    final Function<Exception, Void> _function_1 = new Function<Exception, Void>() {
      public Void apply(final Exception it) {
        return ConnectProgressDialog.this.internalConnectionErrorCallback(it);
      }
    };
