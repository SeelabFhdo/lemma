...
public class ServiceModelTransformationStrategy extends AbstractUiModelTransformationStrategy {
  public final static String DATA_MODEL_FILE_TYPE_ID = "DATA";
  
  public final static String MAPPING_MODEL_FILE_TYPE_ID = "MAPPING";
  
  public final static String SERVICE_MODEL_FILE_TYPE_ID = "SERVICE";
  
  private final static String DATA_DSL_EDITOR_ID = "de.fhdo.ddmm.data.DataDsl";
  
  private final static String SERVICE_DSL_EDITOR_ID = "de.fhdo.ddmm.ServiceDsl";
  
  private final static String MAPPING_DSL_EDITOR_ID = "de.fhdo.ddmm.technology.mappingdsl.MappingDsl";
  
  private final static List<String> DATA_MODEL_FILE_EXTENSIONS = CollectionLiterals.<String>newArrayList();
  
  private final static List<String> SERVICE_MODEL_FILE_EXTENSIONS = CollectionLiterals.<String>newArrayList();
  
  private final static List<String> MAPPING_MODEL_FILE_EXTENSIONS = CollectionLiterals.<String>newArrayList();
  
  private final static String MODEL_TYPE_PREFIX = "service";
  ...
  public ServiceModelTransformationStrategy() {
    ...
    if (_isEmpty) {
      ServiceModelTransformationStrategy.SERVICE_MODEL_FILE_EXTENSIONS.addAll(
        DdmmUiUtils.getFileExtensions(ServiceModelTransformationStrategy.SERVICE_DSL_EDITOR_ID));
    }
    ...
    if (_isEmpty_1) {
      ServiceModelTransformationStrategy.MAPPING_MODEL_FILE_EXTENSIONS.addAll(
        DdmmUiUtils.getFileExtensions(ServiceModelTransformationStrategy.MAPPING_DSL_EDITOR_ID));
    }
    boolean _isEmpty_2 = ServiceModelTransformationStrategy.DATA_MODEL_FILE_EXTENSIONS.isEmpty();
    if (_isEmpty_2) {
      ServiceModelTransformationStrategy.DATA_MODEL_FILE_EXTENSIONS.addAll(DdmmUiUtils.getFileExtensions(ServiceModelTransformationStrategy.DATA_DSL_EDITOR_ID));
    }
  ...
  public Map<String, IFile> getImportedModelFiles(final ModelFile modelFile) {
    ...
    if (_not) {
      boolean _hasExtension = DdmmUiUtils.hasExtension(modelFile.getFile(), ((String[])Conversions.unwrapArray(ServiceModelTransformationStrategy.SERVICE_MODEL_FILE_EXTENSIONS, String.class)));
      if (_hasExtension) {
        ...
        boolean _hasExtension_1 = DdmmUiUtils.hasExtension(modelFile.getFile(), ((String[])Conversions.unwrapArray(ServiceModelTransformationStrategy.MAPPING_MODEL_FILE_EXTENSIONS, String.class)));
        if (_hasExtension_1) {
          ...
          boolean _hasExtension_2 = DdmmUiUtils.hasExtension(modelFile.getFile(), ((String[])Conversions.unwrapArray(ServiceModelTransformationStrategy.DATA_MODEL_FILE_EXTENSIONS, String.class)));
          if (_hasExtension_2) {
  ...
  public String getDefaultTransformationTargetPath(final IFile file) {
    ...
    if (_hasExtension) {
      ...
      boolean _hasExtension_1 = DdmmUiUtils.hasExtension(file, ((String[])Conversions.unwrapArray(ServiceModelTransformationStrategy.SERVICE_MODEL_FILE_EXTENSIONS, String.class)));
      if (_hasExtension_1) {
        _xifexpression_1 = "service models";
      } else {
        String _xifexpression_2 = null;
        boolean _hasExtension_2 = DdmmUiUtils.hasExtension(file, ((String[])Conversions.unwrapArray(ServiceModelTransformationStrategy.MAPPING_MODEL_FILE_EXTENSIONS, String.class)));
        if (_hasExtension_2) {
