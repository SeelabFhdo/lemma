...
final class DdmmUiUtils {
     ...
     */
    static def createImage(ResourceManager resourceManager, String filename) {
        return resourceManager.createImage(createImageDescriptor(filename))
    }

    /**
     * Create an ImageDescriptor for the given filename and the bundle of this class
     */
    static def createImageDescriptor(String filename) {
        val bundle = FrameworkUtil.getBundle(DdmmUiUtils)
