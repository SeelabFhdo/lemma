...
buildscript {
    ...
    extra.set("ddmmUtilsVersion", "0.0.1-SNAPSHOT")
...
dependencies {
    ...
    val ddmmUtilsVersion: String by rootProject.extra
    ...
    implementation("de.fhdo.ddmm:live_validation:$liveValidationVersion")
    implementation("de.fhdo.ddmm:ocl:$oclVersion:all-dependencies-no-kotlin")
    implementation("de.fhdo.ddmm.utils:DdmmUtils:$ddmmUtilsVersion")
