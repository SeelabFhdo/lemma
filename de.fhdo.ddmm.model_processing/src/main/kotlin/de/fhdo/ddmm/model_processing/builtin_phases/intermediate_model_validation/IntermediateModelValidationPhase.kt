package de.fhdo.ddmm.model_processing.builtin_phases.intermediate_model_validation

import de.fhdo.ddmm.model_processing.annotations.IntermediateModelValidator
import de.fhdo.ddmm.model_processing.annotations.ModelProcessingPhase
import de.fhdo.ddmm.model_processing.annotations.RequiresBasicCommandLineOptions
import de.fhdo.ddmm.model_processing.annotations.findAnnotatedClasses
import de.fhdo.ddmm.model_processing.asXmiResource
import de.fhdo.ddmm.model_processing.phases.AbstractModelProcessingPhase
import de.fhdo.ddmm.model_processing.builtin_phases.ValidationEndedWithErrorsException
import de.fhdo.ddmm.model_processing.builtin_phases.ValidationResult
import de.fhdo.ddmm.model_processing.builtin_phases.ValidationResultType
import de.fhdo.ddmm.model_processing.builtin_phases.intermediate_model_query.IntermediateModelQueryPhase
import de.fhdo.ddmm.model_processing.builtin_phases.print
import de.fhdo.ddmm.model_processing.command_line.BasicCommandLine
import de.fhdo.ddmm.model_processing.command_line.BasicOption
import de.fhdo.ddmm.model_processing.extendsImplementsOrException
import de.fhdo.ddmm.model_processing.languages.registerLanguage
import de.fhdo.ddmm.model_processing.readModelingNamespacesFromXmi
