...
import de.fhdo.ddmm.model_processing.getMethod
...
fun <T: Any> List<T>.convertToAbsoluteFileUrisInPlace(resource: Resource) {
    ...
    forEach {
        ...
        if (uri != null) {
            // Use the same mechanism as the intermediate model transformation component of the DDMM project
            val absoluteFileUri = DdmmUtils.convertToAbsoluteFileUri(uri, absoluteBasePathWithoutScheme)
