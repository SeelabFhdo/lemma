...
interface LiveValidationServer : LanguageServer {
     ...
     * [de.fhdo.lemma.live_validation.clients.AbstractLiveValidator] clients
     */
...
interface LiveValidationLanguageClient : LanguageClient {
    ...
    /**
     * Send PerformValidation request from server to [de.fhdo.lemma.live_validation.clients.AbstractLiveValidator]
     * clients
     */
     ...
     * [de.fhdo.lemma.live_validation.clients.AbstractLiveValidationInitiator] clients
     */
