 ...
 * LSP, which communicates issues produced by a concrete [de.fhdo.lemma.live_validation.clients.AbstractLiveValidator]
 * (as a result of the server invoking the validator's ``requestValidation'' method) to a Live Validation client that
 * extends [de.fhdo.lemma.live_validation.clients.AbstractLiveValidationInitiator].
 *
 * @author [Florian Rademacher](mailto:florian.rademacher@fh-dortmund.de)
 */
