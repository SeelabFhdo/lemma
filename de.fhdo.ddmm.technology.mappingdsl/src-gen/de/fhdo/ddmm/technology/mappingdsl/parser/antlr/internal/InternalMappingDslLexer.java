...
public class InternalMappingDslLexer extends Lexer {
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:27:7: ( 'complex' )
            // InternalMappingDsl.g:27:9: 'complex'
            {
            match("complex"); 
    ...
    public final void mRULE_BIG_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6459:18: ( ( '-' )? RULE_INT ( '.' RULE_INT )? )
            // InternalMappingDsl.g:6459:20: ( '-' )? RULE_INT ( '.' RULE_INT )?
            {
            // InternalMappingDsl.g:6459:20: ( '-' )?
            int alt1=2;
            ...
            mRULE_INT(); 
            // InternalMappingDsl.g:6459:34: ( '.' RULE_INT )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalMappingDsl.g:6459:35: '.' RULE_INT
                    {
                    match('.'); 
                    mRULE_INT(); 
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6461:14: ( ( 'true' | 'false' ) )
            // InternalMappingDsl.g:6461:16: ( 'true' | 'false' )
            {
            // InternalMappingDsl.g:6461:16: ( 'true' | 'false' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalMappingDsl.g:6461:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalMappingDsl.g:6461:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6463:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMappingDsl.g:6463:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMappingDsl.g:6463:11: ( '^' )?
            int alt4=2;
            ...
            // InternalMappingDsl.g:6463:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalMappingDsl.g:6465:19: ( ( '0' .. '9' )+ )
            // InternalMappingDsl.g:6465:21: ( '0' .. '9' )+
            {
            // InternalMappingDsl.g:6465:21: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalMappingDsl.g:6465:22: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6467:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMappingDsl.g:6467:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMappingDsl.g:6467:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalMappingDsl.g:6467:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMappingDsl.g:6467:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalMappingDsl.g:6467:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMappingDsl.g:6467:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6469:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMappingDsl.g:6469:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMappingDsl.g:6469:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6471:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMappingDsl.g:6471:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMappingDsl.g:6471:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
            ...
            // InternalMappingDsl.g:6471:40: ( ( '\\r' )? '\\n' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalMappingDsl.g:6471:41: ( '\\r' )? '\\n'
                    {
                    // InternalMappingDsl.g:6471:41: ( '\\r' )?
                    int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6473:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMappingDsl.g:6473:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMappingDsl.g:6473:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMappingDsl.g:6475:16: ( . )
            // InternalMappingDsl.g:6475:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_acceptS =
        "\1\uffff\1\1\1\uffff\1\3\1\4\1\5\1\uffff\1\7\4\uffff\1\15\4\uffff\1\23\1\uffff\1\26\4\uffff\1\43\1\44\10\uffff\1\127\1\uffff\1\131\2\uffff\1\135\1\136\1\1\3\uffff\1\131\1\3\1\4\1\5\3\uffff\1\7\11\uffff\1\15\1\uffff\1\24\1\20\2\uffff\1\22\1\127\1\23\1\133\1\134\1\25\1\26\12\uffff\1\43\1\44\20\uffff\1\132\1\135\15\uffff\1\31\4\uffff\1\116\2\uffff\1\54\41\uffff\1\124\1\123\20\uffff\1\104\4\uffff\1\117\12\uffff\1\71\32\uffff\1\52\1\130\27\uffff\1\100\1\30\14\uffff\1\45\1\101\2\uffff\1\50\2\uffff\1\77\1\55\1\105\5\uffff\1\121\1\75\14\uffff\1\122\4\uffff\1\120\11\uffff\1\42\1\uffff\1\103\12\uffff\1\53\5\uffff\1\106\6\uffff\1\112\5\uffff\1\70\4\uffff\1\27\2\uffff\1\41\6\uffff\1\51\1\uffff\1\125\3\uffff\1\40\3\uffff\1\102\2\uffff\1\107\13\uffff\1\74\1\11\7\uffff\1\21\1\uffff\1\73\1\uffff\1\46\3\uffff\1\33\2\uffff\1\47\1\76\1\uffff\1\60\1\uffff\1\114\2\uffff\1\65\10\uffff\1\110\2\uffff\1\16\1\34\10\uffff\1\67\1\uffff\1\6\1\uffff\1\17\1\uffff\1\10\4\uffff\1\12\2\uffff\1\13\4\uffff\1\62\1\uffff\1\72\1\56\1\2\1\61\1\14\3\uffff\1\36\1\uffff\1\37\1\uffff\1\126\1\113\10\uffff\1\66\1\57\1\uffff\1\111\3\uffff\1\32\3\uffff\1\35\1\uffff\1\115\3\uffff\1\63\2\uffff\1\64";
