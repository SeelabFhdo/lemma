...
public class IntermediatePackageImpl extends EPackageImpl implements IntermediatePackage {
     ...
     * @generated
     */
    private EClass intermediateOperationNodeReferenceEClass = null;
     ...
     * @generated
     */
    public EAttribute getIntermediateContainer_QualifiedDeploymentTechnologyName() {
        return (EAttribute)intermediateContainerEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EAttribute getIntermediateInfrastructureNode_QualifiedInfrastructureTechnologyName() {
        return (EAttribute)intermediateInfrastructureNodeEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EClass getIntermediateOperationNodeReference() {
        return intermediateOperationNodeReferenceEClass;
    }
     ...
     * @generated
     */
    public EAttribute getIntermediateOperationNodeReference_Imported() {
        return (EAttribute)intermediateOperationNodeReferenceEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EAttribute getIntermediateOperationNodeReference_Name() {
        return (EAttribute)intermediateOperationNodeReferenceEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EAttribute getIntermediateOperationNodeReference_QualifiedTechnologyName() {
        return (EAttribute)intermediateOperationNodeReferenceEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getIntermediateOperationNodeReference_Import() {
        return (EReference)intermediateOperationNodeReferenceEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EReference getIntermediateOperationNodeReference_DependOnNode() {
        return (EReference)intermediateOperationNodeReferenceEClass.getEStructuralFeatures().get(4);
    }
     ...
     * @generated
     */
    public EReference getIntermediateOperationNodeReference_UsedByNode() {
        return (EReference)intermediateOperationNodeReferenceEClass.getEStructuralFeatures().get(5);
    }
    ...
    public void createPackageContents() {
        ...
        createEAttribute(intermediateContainerEClass, INTERMEDIATE_CONTAINER__QUALIFIED_DEPLOYMENT_TECHNOLOGY_NAME);
        ...
        createEAttribute(intermediateInfrastructureNodeEClass, INTERMEDIATE_INFRASTRUCTURE_NODE__QUALIFIED_INFRASTRUCTURE_TECHNOLOGY_NAME);
        ...
        intermediateOperationNodeReferenceEClass = createEClass(INTERMEDIATE_OPERATION_NODE_REFERENCE);
        createEAttribute(intermediateOperationNodeReferenceEClass, INTERMEDIATE_OPERATION_NODE_REFERENCE__IMPORTED);
        createEAttribute(intermediateOperationNodeReferenceEClass, INTERMEDIATE_OPERATION_NODE_REFERENCE__NAME);
        createEAttribute(intermediateOperationNodeReferenceEClass, INTERMEDIATE_OPERATION_NODE_REFERENCE__QUALIFIED_TECHNOLOGY_NAME);
        createEReference(intermediateOperationNodeReferenceEClass, INTERMEDIATE_OPERATION_NODE_REFERENCE__IMPORT);
        createEReference(intermediateOperationNodeReferenceEClass, INTERMEDIATE_OPERATION_NODE_REFERENCE__DEPEND_ON_NODE);
        createEReference(intermediateOperationNodeReferenceEClass, INTERMEDIATE_OPERATION_NODE_REFERENCE__USED_BY_NODE);
    }
    ...
    public void initializePackageContents() {
        ...
        initEReference(getIntermediateOperationNode_DependsOnNodes(), this.getIntermediateOperationNodeReference(), this.getIntermediateOperationNodeReference_DependOnNode(), "dependsOnNodes", null, 0, -1, IntermediateOperationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIntermediateOperationNode_UsedByNodes(), this.getIntermediateOperationNodeReference(), this.getIntermediateOperationNodeReference_UsedByNode(), "usedByNodes", null, 0, -1, IntermediateOperationNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getIntermediateContainer_QualifiedDeploymentTechnologyName(), theEcorePackage.getEString(), "qualifiedDeploymentTechnologyName", null, 0, 1, IntermediateContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getIntermediateInfrastructureNode_QualifiedInfrastructureTechnologyName(), theEcorePackage.getEString(), "qualifiedInfrastructureTechnologyName", null, 0, 1, IntermediateInfrastructureNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEClass(intermediateOperationNodeReferenceEClass, IntermediateOperationNodeReference.class, "IntermediateOperationNodeReference", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getIntermediateOperationNodeReference_Imported(), theEcorePackage.getEBoolean(), "imported", "false", 0, 1, IntermediateOperationNodeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getIntermediateOperationNodeReference_Name(), theEcorePackage.getEString(), "name", null, 0, 1, IntermediateOperationNodeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getIntermediateOperationNodeReference_QualifiedTechnologyName(), theEcorePackage.getEString(), "qualifiedTechnologyName", null, 0, 1, IntermediateOperationNodeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIntermediateOperationNodeReference_Import(), theIntermediatePackage_1.getIntermediateImport(), null, "import", null, 0, 1, IntermediateOperationNodeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIntermediateOperationNodeReference_DependOnNode(), this.getIntermediateOperationNode(), this.getIntermediateOperationNode_DependsOnNodes(), "dependOnNode", null, 0, 1, IntermediateOperationNodeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIntermediateOperationNodeReference_UsedByNode(), this.getIntermediateOperationNode(), this.getIntermediateOperationNode_UsedByNodes(), "usedByNode", null, 0, 1, IntermediateOperationNodeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
