...
public abstract class IntermediateOperationNodeImpl extends MinimalEObjectImpl.Container implements IntermediateOperationNode {
     ...
     * @ordered
     */
    protected EList<IntermediateOperationNodeReference> dependsOnNodes;
     ...
     * @ordered
     */
    protected EList<IntermediateOperationNodeReference> usedByNodes;
     ...
     */
    @Override
    public EList<IntermediateOperationNodeReference> getDependsOnNodes() {
        if (dependsOnNodes == null) {
            dependsOnNodes = new EObjectContainmentWithInverseEList<IntermediateOperationNodeReference>(IntermediateOperationNodeReference.class, this, IntermediatePackage.INTERMEDIATE_OPERATION_NODE__DEPENDS_ON_NODES, IntermediatePackage.INTERMEDIATE_OPERATION_NODE_REFERENCE__DEPEND_ON_NODE);
        }
     ...
     */
    @Override
    public EList<IntermediateOperationNodeReference> getUsedByNodes() {
        if (usedByNodes == null) {
            usedByNodes = new EObjectContainmentWithInverseEList<IntermediateOperationNodeReference>(IntermediateOperationNodeReference.class, this, IntermediatePackage.INTERMEDIATE_OPERATION_NODE__USED_BY_NODES, IntermediatePackage.INTERMEDIATE_OPERATION_NODE_REFERENCE__USED_BY_NODE);
        }
        return usedByNodes;
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case IntermediatePackage.INTERMEDIATE_OPERATION_NODE__DEPENDS_ON_NODES:
                return ((InternalEList<InternalEObject>)(InternalEList<?>)getDependsOnNodes()).basicAdd(otherEnd, msgs);
            case IntermediatePackage.INTERMEDIATE_OPERATION_NODE__USED_BY_NODES:
                return ((InternalEList<InternalEObject>)(InternalEList<?>)getUsedByNodes()).basicAdd(otherEnd, msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case IntermediatePackage.INTERMEDIATE_OPERATION_NODE__DEPENDS_ON_NODES:
                ...
                getDependsOnNodes().addAll((Collection<? extends IntermediateOperationNodeReference>)newValue);
                return;
            case IntermediatePackage.INTERMEDIATE_OPERATION_NODE__USED_BY_NODES:
                getUsedByNodes().clear();
                getUsedByNodes().addAll((Collection<? extends IntermediateOperationNodeReference>)newValue);
                return;
        }
