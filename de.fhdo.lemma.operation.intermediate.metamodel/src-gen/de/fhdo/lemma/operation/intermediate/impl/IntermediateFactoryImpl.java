...
public class IntermediateFactoryImpl extends EFactoryImpl implements IntermediateFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case IntermediatePackage.INTERMEDIATE_OPERATION_NODE_REFERENCE: return createIntermediateOperationNodeReference();
            default:
     ...
     * @generated
     */
    public IntermediateOperationNodeReference createIntermediateOperationNodeReference() {
        IntermediateOperationNodeReferenceImpl intermediateOperationNodeReference = new IntermediateOperationNodeReferenceImpl();
        return intermediateOperationNodeReference;
    }
