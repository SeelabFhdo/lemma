...
public class IntermediateSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case IntermediatePackage.INTERMEDIATE_OPERATION_NODE_REFERENCE: {
                IntermediateOperationNodeReference intermediateOperationNodeReference = (IntermediateOperationNodeReference)theEObject;
                T result = caseIntermediateOperationNodeReference(intermediateOperationNodeReference);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Operation Node Reference</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Operation Node Reference</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseIntermediateOperationNodeReference(IntermediateOperationNodeReference object) {
        return null;
    }
