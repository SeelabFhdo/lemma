...
public class IntermediateAdapterFactory extends AdapterFactoryImpl {
    ...
    protected IntermediateSwitch<Adapter> modelSwitch =
        new IntermediateSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseIntermediateOperationNodeReference(IntermediateOperationNodeReference object) {
                return createIntermediateOperationNodeReferenceAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fhdo.lemma.operation.intermediate.IntermediateOperationNodeReference <em>Operation Node Reference</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createIntermediateOperationNodeReferenceAdapter() {
        return null;
    }
