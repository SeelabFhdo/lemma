 ...
 * </p>
 * <ul>
 *   <li>{@link de.fhdo.lemma.operation.intermediate.IntermediateContainer#getQualifiedDeploymentTechnologyName <em>Qualified Deployment Technology Name</em>}</li>
...
public interface IntermediateContainer extends IntermediateOperationNode {
	/**
	 * Returns the value of the '<em><b>Qualified Deployment Technology Name</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Qualified Deployment Technology Name</em>' attribute.
	 * @see #setQualifiedDeploymentTechnologyName(String)
	 * @see de.fhdo.lemma.operation.intermediate.IntermediatePackage#getIntermediateContainer_QualifiedDeploymentTechnologyName()
	 * @model unique="false"
	 * @generated
	 */
	String getQualifiedDeploymentTechnologyName();

	/**
	 * Sets the value of the '{@link de.fhdo.lemma.operation.intermediate.IntermediateContainer#getQualifiedDeploymentTechnologyName <em>Qualified Deployment Technology Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Qualified Deployment Technology Name</em>' attribute.
	 * @see #getQualifiedDeploymentTechnologyName()
	 * @generated
	 */
	void setQualifiedDeploymentTechnologyName(String value);
