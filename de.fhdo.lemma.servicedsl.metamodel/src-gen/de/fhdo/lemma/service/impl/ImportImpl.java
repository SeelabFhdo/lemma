 ...
 *   <li>{@link de.fhdo.lemma.service.impl.ImportImpl#getExternalURI <em>External URI</em>}</li>
...
public class ImportImpl extends MinimalEObjectImpl.Container implements Import {
    ...
    public void setExternalURI(String newExternalURI) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.IMPORT__EXTERNAL_URI, oldExternalURI, externalURI));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ServicePackage.IMPORT__IMPORT_URI:
                return getImportURI();
            case ServicePackage.IMPORT__EXTERNAL_URI:
