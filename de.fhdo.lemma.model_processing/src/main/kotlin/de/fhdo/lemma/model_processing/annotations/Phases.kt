 ...
 * see [de.fhdo.lemma.model_processing.builtin_phases.live_validation.SourceModelLiveValidationPhase].
 *
 * @author [Florian Rademacher](mailto:florian.rademacher@fh-dortmund.de)
 */
@Target(AnnotationTarget.CLASS)
 ...
 * [de.fhdo.lemma.model_processing.builtin_phases.source_model_validation.AbstractXtextSourceModelValidator], annotated
