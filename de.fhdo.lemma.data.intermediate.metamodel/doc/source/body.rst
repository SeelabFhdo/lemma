...
.. java:type:: class IntermediateEnumeration extends IntermediateComplexType
    ...
    .. _link__IntermediateEnumeration_featureNames:

    .. py:attribute:: String[*] featureNames

        This attribute contains the names of all features specified for the
        enumeration. The following values are possible:

        ======================   ===============================================
        **Feature Name**         **Description**
        ----------------------   -----------------------------------------------
             DOMAIN_EVENT        Enumeration is a Domain Event
                                 [#enterprise-patterns-event-message]_.
        ----------------------   -----------------------------------------------
              VALUE_OBJECT       Enumeration is a Value Object in the sense of
                                 DDD.
        ======================   ===============================================
...
.. java:type:: class IntermediateImportedAspect
    ...
    .. py:attribute:: String[1] qualifiedName
        ...
        Qualified name of the aspect. The qualified name of the aspect consists
        of the name of its defining technology, e.g., `\"java\"`, and the name
        of the aspect, separated by a dot.
