...
public class TransformationDialogHandler extends AbstractHandler {
   ...
   * Constructor
   */
  public TransformationDialogHandler(final List<ModelFile> inputModelFiles, final boolean convertToRelativeUris, final boolean outputRefinementModels, final AbstractUiModelTransformationStrategy strategy) {
  ...
  public Object execute(final ExecutionEvent event) throws ExecutionException {
    final TransformationDialog dialog = new TransformationDialog(this.SHELL, this.strategy, this.inputModelFiles, 
      this.convertToRelativeUris, this.outputRefinementModels);
    dialog.create();
