package de.fhdo.lemma.intermediate.transformations.ui.transformation_dialog;
...
public class TransformationDialog extends TitleAreaDialog {
  ...
  public Control createDialogArea(final Composite parent) {
    ...
    this.progressTitleLabel.setImage(
      LemmaUiUtils.createImage(TransformationDialog.RESOURCE_MANAGER, this.getClass(), "transformedFile.gif"));
