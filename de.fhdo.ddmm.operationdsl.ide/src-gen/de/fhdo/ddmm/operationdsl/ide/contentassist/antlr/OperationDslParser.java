...
public class OperationDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OperationDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInfrastructureNodeAccess().getGroup_12(), "rule__InfrastructureNode__Group_12__0");
			...
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDeployedServicesAssignment_7(), "rule__InfrastructureNode__DeployedServicesAssignment_7");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDeployedServicesAssignment_8_1(), "rule__InfrastructureNode__DeployedServicesAssignment_8_1");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getAspectsAssignment_10_2(), "rule__InfrastructureNode__AspectsAssignment_10_2");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDefaultServicePropertyValuesAssignment_11_3(), "rule__InfrastructureNode__DefaultServicePropertyValuesAssignment_11_3");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getEndpointsAssignment_12_2(), "rule__InfrastructureNode__EndpointsAssignment_12_2");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDeploymentSpecificationsAssignment_13(), "rule__InfrastructureNode__DeploymentSpecificationsAssignment_13");
