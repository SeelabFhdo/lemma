...
public class OperationDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OperationDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInfrastructureNodeAccess().getGroup_8(), "rule__InfrastructureNode__Group_8__0");
			...
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDeployedServicesAssignment_5_3(), "rule__InfrastructureNode__DeployedServicesAssignment_5_3");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDeployedServicesAssignment_5_4_1(), "rule__InfrastructureNode__DeployedServicesAssignment_5_4_1");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getUsedByNodesAssignment_6_3(), "rule__InfrastructureNode__UsedByNodesAssignment_6_3");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getUsedByNodesAssignment_6_4_1(), "rule__InfrastructureNode__UsedByNodesAssignment_6_4_1");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getAspectsAssignment_8_2(), "rule__InfrastructureNode__AspectsAssignment_8_2");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDefaultServicePropertyValuesAssignment_9_3(), "rule__InfrastructureNode__DefaultServicePropertyValuesAssignment_9_3");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getEndpointsAssignment_10_2(), "rule__InfrastructureNode__EndpointsAssignment_10_2");
			builder.put(grammarAccess.getInfrastructureNodeAccess().getDeploymentSpecificationsAssignment_11(), "rule__InfrastructureNode__DeploymentSpecificationsAssignment_11");
