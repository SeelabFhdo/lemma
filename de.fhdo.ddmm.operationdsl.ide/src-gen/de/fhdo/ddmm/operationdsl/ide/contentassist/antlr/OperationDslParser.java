	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getContainerAccess().getAlternatives_16_3(), "rule__Container__Alternatives_16_3");
					put(grammarAccess.getImportedOperationAspectAccess().getAlternatives_1(), "rule__ImportedOperationAspect__Alternatives_1");
					put(grammarAccess.getImportedOperationAspectAccess().getAlternatives_1_0_1(), "rule__ImportedOperationAspect__Alternatives_1_0_1");
					...
					put(grammarAccess.getContainerAccess().getGroup_13(), "rule__Container__Group_13__0");
					put(grammarAccess.getContainerAccess().getGroup_15(), "rule__Container__Group_15__0");
					put(grammarAccess.getContainerAccess().getGroup_16(), "rule__Container__Group_16__0");
					put(grammarAccess.getContainerAccess().getGroup_16_3_1(), "rule__Container__Group_16_3_1__0");
					put(grammarAccess.getContainerAccess().getGroup_16_3_2(), "rule__Container__Group_16_3_2__0");
					...
					put(grammarAccess.getInfrastructureNodeAccess().getGroup_14(), "rule__InfrastructureNode__Group_14__0");
					put(grammarAccess.getInfrastructureNodeAccess().getGroup_15(), "rule__InfrastructureNode__Group_15__0");
					put(grammarAccess.getInfrastructureNodeAccess().getGroup_16(), "rule__InfrastructureNode__Group_16__0");
					put(grammarAccess.getProtocolAndDataFormatAccess().getGroup(), "rule__ProtocolAndDataFormat__Group__0");
					put(grammarAccess.getProtocolAndDataFormatAccess().getGroup_1(), "rule__ProtocolAndDataFormat__Group_1__0");
					...
					put(grammarAccess.getContainerAccess().getTechnologyAssignment_3(), "rule__Container__TechnologyAssignment_3");
					put(grammarAccess.getContainerAccess().getNameAssignment_6(), "rule__Container__NameAssignment_6");
					put(grammarAccess.getContainerAccess().getDeploymentTechnologyAssignment_9(), "rule__Container__DeploymentTechnologyAssignment_9");
					put(grammarAccess.getContainerAccess().getOperationEnvironmentAssignment_10_3(), "rule__Container__OperationEnvironmentAssignment_10_3");
					put(grammarAccess.getContainerAccess().getDeployedServicesAssignment_12(), "rule__Container__DeployedServicesAssignment_12");
					put(grammarAccess.getContainerAccess().getDeployedServicesAssignment_13_1(), "rule__Container__DeployedServicesAssignment_13_1");
					put(grammarAccess.getContainerAccess().getAspectsAssignment_15_2(), "rule__Container__AspectsAssignment_15_2");
					put(grammarAccess.getContainerAccess().getDefaultServicePropertyValuesAssignment_16_3_0(), "rule__Container__DefaultServicePropertyValuesAssignment_16_3_0");
					put(grammarAccess.getContainerAccess().getDefaultBasicEndpointsAssignment_16_3_1_3(), "rule__Container__DefaultBasicEndpointsAssignment_16_3_1_3");
					put(grammarAccess.getContainerAccess().getDefaultServicePropertyValuesAssignment_16_3_2_0(), "rule__Container__DefaultServicePropertyValuesAssignment_16_3_2_0");
					put(grammarAccess.getContainerAccess().getDefaultBasicEndpointsAssignment_16_3_2_4(), "rule__Container__DefaultBasicEndpointsAssignment_16_3_2_4");
					put(grammarAccess.getContainerAccess().getDeploymentSpecificationsAssignment_17(), "rule__Container__DeploymentSpecificationsAssignment_17");
					put(grammarAccess.getInfrastructureNodeAccess().getTechnologyAssignment_3(), "rule__InfrastructureNode__TechnologyAssignment_3");
					put(grammarAccess.getInfrastructureNodeAccess().getNameAssignment_5(), "rule__InfrastructureNode__NameAssignment_5");
					put(grammarAccess.getInfrastructureNodeAccess().getInfrastructureTechnologyAssignment_7(), "rule__InfrastructureNode__InfrastructureTechnologyAssignment_7");
					put(grammarAccess.getInfrastructureNodeAccess().getOperationEnvironmentAssignment_8_3(), "rule__InfrastructureNode__OperationEnvironmentAssignment_8_3");
					put(grammarAccess.getInfrastructureNodeAccess().getDeployedServicesAssignment_11(), "rule__InfrastructureNode__DeployedServicesAssignment_11");
					put(grammarAccess.getInfrastructureNodeAccess().getDeployedServicesAssignment_12_1(), "rule__InfrastructureNode__DeployedServicesAssignment_12_1");
					put(grammarAccess.getInfrastructureNodeAccess().getAspectsAssignment_14_2(), "rule__InfrastructureNode__AspectsAssignment_14_2");
					put(grammarAccess.getInfrastructureNodeAccess().getDefaultServicePropertyValuesAssignment_15_3(), "rule__InfrastructureNode__DefaultServicePropertyValuesAssignment_15_3");
					put(grammarAccess.getInfrastructureNodeAccess().getEndpointsAssignment_16_2(), "rule__InfrastructureNode__EndpointsAssignment_16_2");
					put(grammarAccess.getInfrastructureNodeAccess().getDeploymentSpecificationsAssignment_17(), "rule__InfrastructureNode__DeploymentSpecificationsAssignment_17");
					put(grammarAccess.getProtocolAndDataFormatAccess().getProtocolAssignment_0(), "rule__ProtocolAndDataFormat__ProtocolAssignment_0");
					put(grammarAccess.getProtocolAndDataFormatAccess().getDataFormatAssignment_1_1(), "rule__ProtocolAndDataFormat__DataFormatAssignment_1_1");
