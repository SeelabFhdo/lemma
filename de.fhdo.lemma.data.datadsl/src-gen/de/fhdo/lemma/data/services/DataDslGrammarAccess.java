...
public class DataDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DataStructureElements extends AbstractParserRuleElementFinder {
		...
		//((dataFields+=DataField | operations+=DataOperation) (',' (dataFields+=DataField | operations+=DataOperation))*)?
	...
	public class EnumerationElements extends AbstractParserRuleElementFinder {
		...
		//'enum' name=ID ('<' features+=ComplexTypeFeature (',' features+=ComplexTypeFeature)* '>')? '{' fields+=EnumerationField
	...
	public class DataOperationElements extends AbstractParserRuleElementFinder {
		...
		//complexReturnType=[ComplexType|QualifiedName] | importedComplexReturnType=ImportedComplexType)?) name=ID ('('
		//parameters+=DataOperationParameter? (',' parameters+=DataOperationParameter)* ')')? ('<' features+=DataOperationFeature
		...
		//complexReturnType=[ComplexType|QualifiedName] | importedComplexReturnType=ImportedComplexType)?)
		public Alternatives getAlternatives_1() { return cAlternatives_1; }
		...
		//(primitiveReturnType=PrimitiveType | complexReturnType=[ComplexType|QualifiedName] |
		//importedComplexReturnType=ImportedComplexType)?
	...
	public class ComplexTypeFeatureElements extends AbstractEnumRuleElementFinder {
