...
# Use this script to build the MariaDB Generator Docker image locally. The
# script can receive a single argument to identify the version of the MariaDB
...
# MariaDB Generator to exist in the local filesystem.
