...
# Use this script to build the Spring Cloud Eureka Generator Docker image
# locally. The script can receive a single argument to identify the version of
# the Spring Cloud Eureka Generator to pass it to the Dockerfile. The current
...
# Spring Cloud Eureka Generator to exist in the local filesystem.
