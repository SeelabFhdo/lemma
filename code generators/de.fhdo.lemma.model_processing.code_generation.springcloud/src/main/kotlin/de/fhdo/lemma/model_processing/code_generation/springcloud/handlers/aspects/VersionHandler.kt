...
/**
 * Handler for the Version aspect.
 *
 * @author [Florian Rademacher](mailto:florian.rademacher@fh-dortmund.de)
 */
@AspectHandler
internal class VersionHandler : AspectHandlerI {
    override fun handlesAspects() = "Version".forAllTechnologies()
    ...
    override fun execute(eObject: EObject, node: Node, aspect: IntermediateImportedAspect) : Node {
        ...
        generatedField.addImport("javax.persistence.Version", ImportTargetElementType.ANNOTATION)
        generatedField.addAnnotation("Version")
        return node
    }
}