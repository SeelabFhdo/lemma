...
internal class ValidHandler : AspectHandlerI {
    override fun handlesAspects() = "Valid".forAllTechnologies()
    ...
    override fun execute(eObject: EObject, node: Node, aspect: IntermediateImportedAspect) : Node {
        ...
        generatedField.addImport("javax.validation.Valid", ImportTargetElementType.ANNOTATION)
        generatedField.addAnnotation("Valid")
        return node
    }
}