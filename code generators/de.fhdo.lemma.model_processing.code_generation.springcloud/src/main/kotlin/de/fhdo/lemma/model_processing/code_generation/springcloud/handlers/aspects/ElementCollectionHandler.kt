...
/**
 * Handler for the java.ElementCollection aspect.
 *
 * @author [Florian Rademacher](mailto:florian.rademacher@fh-dortmund.de)
 */
@AspectHandler
internal class ElementCollectionHandler : AspectHandlerI {
    override fun handlesAspects() = setOf("java.ElementCollection")
    ...
    override fun execute(eObject: EObject, node: Node, aspect: IntermediateImportedAspect) : Node {
        ...
        // @CollectionTable annotation if explicitly configured by the "collectionTableName" aspect property or
        // derivable from the annotated field.
        ...
        val collectionTableName = aspect.getPropertyValue("collectionTableName")
