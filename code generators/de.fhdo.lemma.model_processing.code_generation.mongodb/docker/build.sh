...
# Use this script to build the MongoDB Generator Docker image locally. The
# script can receive a single argument to identify the version of the MongoDB
...
# MongoDB Generator to exist in the local filesystem.
