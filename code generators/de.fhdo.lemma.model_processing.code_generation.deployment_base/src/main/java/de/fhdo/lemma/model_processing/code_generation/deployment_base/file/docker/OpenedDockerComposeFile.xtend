...
class OpenedDockerComposeFile {
    ...
    private def DockerComposeService getServiceFromContainer(IntermediateContainer container) {
        ...
        container.endpoints.forEach[endpoint |
            ...
            // microservice. According to the Deployment Base Generator, each container requires an
            ...
            // the Deployment Base Generator's intermediate model validator by which we prevent
