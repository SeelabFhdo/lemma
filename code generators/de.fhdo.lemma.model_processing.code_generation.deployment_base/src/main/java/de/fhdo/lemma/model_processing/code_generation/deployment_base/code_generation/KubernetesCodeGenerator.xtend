...
import de.fhdo.lemma.model_processing.code_generation.deployment_base.template.KubernetesTemplate
import java.io.File
import org.jetbrains.annotations.NotNull

/**
 * Main class of the Kubernetes deployment file generation module of the Deployment Base Generator.
 *
...
class KubernetesCodeGenerator extends AbstractCodeGenerationModule {
    ...
    override execute(String[] phaseArguments, String[] moduleArguments) {
        ...
        getContainersWithDeploymentBaseTechnology(model)
            .forEach[createKuberntesFileForContainer(it)]
