...
class ContainerBaseLanguageDescriptionProvider implements LanguageDescriptionProviderI {
    /**
    ...
    override getLanguageDescription(String namespace) {
        switch namespace {
            case OperationPackage.eNS_URI : return new XtextLanguageDescription(
                OperationPackage.eINSTANCE, new OperationDslStandaloneSetup)
            case IntermediatePackage.eNS_URI : return new LanguageDescription(
