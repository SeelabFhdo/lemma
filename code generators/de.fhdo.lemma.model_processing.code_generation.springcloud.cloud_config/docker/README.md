# LEMMA Spring Cloud Config Generator Docker Image
The `lemma/config_generator` Docker image bundles LEMMA's
[Spring Cloud Config Generator](https://github.com/SeelabFhdo/lemma/tree/main/code%20generators/de.fhdo.lemma.model_processing.code_generation.springcloud.cloud_condig)
...
local availability of the `lemma/config_generator` Docker image and guide the
user to install it, if it does not exist already. Furthermore, the script
simplifies the command line invocation of the Spring Cloud Config Generator. To
...
/scripts/run_model_processor.py \
    /code generators/de.fhdo.lemma.model_processing.code_generation.springcloud.cloud_config/docker/execution.yaml \
    -b "/home/user" \
