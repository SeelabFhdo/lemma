...
SPRINGCLOUD_KEYCLOAK_PATH="$HOME/masterthesis/eclipse-workspace/lemma/code generators/de.fhdo.lemma.model_processing.code_generation.springcloud.keycloak/build/libs/de.fhdo.lemma.model_processing.code_generation.springcloud.keycloak-0.8.5-SNAPSHOT.jar"
...
java -jar "$JAVABASE_PATH" \
    ...
    --genlet "$SPRINGCLOUD_KEYCLOAK_PATH"
