...
import de.fhdo.lemma.model_processing.code_generation.keycloak.operation.utils.FileType
import de.fhdo.lemma.model_processing.code_generation.keycloak.operation.utils.generateFilePath
...
internal fun FileType.filePath() = when (this) {
    FileType.APPLICATION_PROPERTIES -> {
        de.fhdo.lemma.model_processing.code_generation.keycloak.operation.modul_handler.PathSpecifier.CURRENT_MICROSERVICE_RESOURCES_PATH
    }
    FileType.CLIENT_CERTIFICATE_PROPERTIES, FileType.CA_CERTIFICATE_PROPERTIES -> {
        de.fhdo.lemma.model_processing.code_generation.keycloak.operation.modul_handler.PathSpecifier.CURRENT_MICROSERVICE_CERTIFICATIONS_TARGET_PATH
    }
}
