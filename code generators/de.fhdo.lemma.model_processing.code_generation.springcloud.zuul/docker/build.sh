...
# Use this script to build the Spring Cloud Zuul Generator Docker image locally.
# The script can receive a single argument to identify the version of the Spring
# Cloud Zuul Generator to pass it to the Dockerfile. The current version of the
# generator may be found in the
...
# Spring Cloud Zuul Generator to exist in the local filesystem.
