 ...
 * Validation [servers](de.fhdo.ddmm.live_validation.server.ServerRunner) and
 * [clients]((de.fhdo.ddmm.live_validation.clients.BaseClient) cope with runtime exceptions (cf.
