 ...
 */
class DataModelTransformationStrategy extends AbstractUiModelTransformationStrategy {
    ...
    static val String MODEL_TYPE_PREFIX = "data"
    ...
    override getModelFileTypeExtensions() {
        ...
        modelTypeFileExtensions.addAll(DATA_MODEL_FILE_EXTENSIONS)
    ...
    override getDefaultTransformationTargetPath(IFile file) {
        ...
        return '''/intermediate/data models/«filenameWithoutExtension».xmi'''
    }
}